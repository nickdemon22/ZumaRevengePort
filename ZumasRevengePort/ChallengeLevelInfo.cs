...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000F2A RID: 3882 RVA: 0x0009CD88 File Offset: 0x0009AF88
		public ChallengeLevelInfo(ChallengeMenu aMenu) : base(10, false, "", "", "", 2)
		{
			...
			if ((int)Localization.GetCurrentLanguage() == 6 || (int)Localization.GetCurrentLanguage() == 7 || (int)Localization.GetCurrentLanguage() == 11 || (int)Localization.GetCurrentLanguage() == 8 || (int)Localization.GetCurrentLanguage() == 4 || (int)Localization.GetCurrentLanguage() == 9 || (int)Localization.GetCurrentLanguage() == 3)
			{
				this.lang_offset = -65;
			}
		}

		// Token: 0x06000F2B RID: 3883 RVA: 0x0009CE7A File Offset: 0x0009B07A
		...
		// Token: 0x06000F2C RID: 3884 RVA: 0x0009CEB0 File Offset: 0x0009B0B0
		...
		// Token: 0x06000F2D RID: 3885 RVA: 0x0009CF78 File Offset: 0x0009B178
		...
		// Token: 0x06000F2E RID: 3886 RVA: 0x0009D4D4 File Offset: 0x0009B6D4
		public void DrawLevelName(SexyGraphics g)
		{
			...
			string text = this.mChallengeLevelNum + 1 + " - " + GameApp.gApp.GetLevelMgr().mLevels[num].mDisplayName;
			int num2 = g.GetFont().StringWidth(text);
			g.DrawString(text, (this.mWidth - num2) / 2, Common._DS(320));
		}

		// Token: 0x06000F2F RID: 3887 RVA: 0x0009D570 File Offset: 0x0009B770
		...
		// Token: 0x06000F30 RID: 3888 RVA: 0x0009D648 File Offset: 0x0009B848
		...
		// Token: 0x06000F31 RID: 3889 RVA: 0x0009D65F File Offset: 0x0009B85F
