...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000E34 RID: 3636 RVA: 0x0008F2D8 File Offset: 0x0008D4D8
		protected override void DrawBossSpecificArt(SexyGraphics g)
		{
			...
			this.DrawGlowingRings(g, this.mStaff[0].mRingSize, Common._S(this.mStaff[0].mYOff), (float)Common._S(Common._M(160)), (float)Common._S(Common._M1(70)), new Color(Common._M2(255), Common._M3(224), Common._M4(0), (int)this.mStaff[0].mRingAlpha), new Color(Common._M(255), Common._M1(255), Common._M2(0), (int)(this.mStaff[0].mRingAlpha / Common._M3(2f))), new Color(Common._M4(255), Common._M5(0), Common._M6(0), (int)(this.mStaff[0].mRingAlpha / Common._M7(3f))));
			this.DrawGlowingRings(g, this.mStaff[1].mRingSize, Common._S(this.mStaff[1].mYOff), (float)Common._S(Common._M(15)), (float)Common._S(Common._M1(70)), new Color(Common._M2(36), Common._M3(18), Common._M4(53), (int)this.mStaff[1].mRingAlpha), new Color(Common._M(36), Common._M1(18), Common._M2(53), (int)(this.mStaff[1].mRingAlpha / Common._M3(2f))), new Color(Common._M4(255), Common._M5(0), Common._M6(0), (int)(this.mStaff[1].mRingAlpha / Common._M7(3f))));
			g.PopState();
		}

		// Token: 0x06000E35 RID: 3637 RVA: 0x0008F6C2 File Offset: 0x0008D8C2
		protected override void DrawBerserk(SexyGraphics g)
		{
		}

		// Token: 0x06000E36 RID: 3638 RVA: 0x0008F6C4 File Offset: 0x0008D8C4
		...
		// Token: 0x06000E37 RID: 3639 RVA: 0x0008F734 File Offset: 0x0008D934
		protected override void DidFire()
		{
			...
			if (!this.mIsFiring)
			{
				int num = Common.size<BossBullet>(this.mBullets) - base.mMaxBulletsToFire;
			...
			for (int i = Common.size<BossBullet>(this.mBullets) - 1; i >= Common.size<BossBullet>(this.mBullets) - base.mMaxBulletsToFire; i--)
			{
		...
		// Token: 0x06000E38 RID: 3640 RVA: 0x0008F870 File Offset: 0x0008DA70
		protected override void DidRetaliate(int num_shot)
		{
			if (!this.mIsRetaliating)
			{
				int num = Common.size<BossBullet>(this.mBullets) - num_shot;
			...
			for (int i = Common.size<BossBullet>(this.mBullets) - 1; i >= Common.size<BossBullet>(this.mBullets) - num_shot; i--)
			{
		...
		// Token: 0x06000E39 RID: 3641 RVA: 0x0008F998 File Offset: 0x0008DB98
		...
		// Token: 0x06000E3A RID: 3642 RVA: 0x0008FA88 File Offset: 0x0008DC88
		...
		// Token: 0x06000E3B RID: 3643 RVA: 0x0008FE80 File Offset: 0x0008E080
		protected bool PreState0Helper(int staffnum, BossBullet b)
		{
			if (b.mImageNum == staffnum && this.mStaff[staffnum].mYOff <= (float)BossDoctor.MAX_SPEAR_Y_OFF && this.mStaff[staffnum].mRingAlpha >= 255f)
			{
				...
				{
					bool flag = false;
					for (int i = 0; i < Common.size<BossBulletParticleSystem>(this.mParticles); i++)
					{
		...
		// Token: 0x06000E3C RID: 3644 RVA: 0x00090054 File Offset: 0x0008E254
		...
		// Token: 0x06000E3D RID: 3645 RVA: 0x00090180 File Offset: 0x0008E380
		...
		// Token: 0x06000E3E RID: 3646 RVA: 0x00090300 File Offset: 0x0008E500
		protected override void DrawWalls(SexyGraphics g)
		{
			int[] array = new int[]
			{
		...
		// Token: 0x06000E3F RID: 3647 RVA: 0x00090564 File Offset: 0x0008E764
		...
		// Token: 0x06000E40 RID: 3648 RVA: 0x000906F4 File Offset: 0x0008E8F4
		...
		// Token: 0x06000E41 RID: 3649 RVA: 0x00090892 File Offset: 0x0008EA92
		...
		// Token: 0x06000E42 RID: 3650 RVA: 0x000908A5 File Offset: 0x0008EAA5
		protected void AddParticleSystem(int bullet_id, int x, int y, int attached)
		{
			this.AddParticleSystem(bullet_id, x, y, attached, 0);
		}

		// Token: 0x06000E43 RID: 3651 RVA: 0x000908B4 File Offset: 0x0008EAB4
		protected void AddParticleSystem(int bullet_id, int x, int y, int attached, int delay)
		{
			...
			bossBulletParticleSystem.mSystem = new PILSystem(50, 50);
			...
			emitterSettings.mEmissionRange = Common.DegreesToRadians(163f);
			...
			particleType3.AddSettingsKeyFrame(0, new ParticleSettings
			{
				...
				mXSize = Common._M(9),
				mSpin = Common.DegreesToRadians((float)Common._M(50))
			});
			particleType3.AddVarianceKeyFrame(0, new ParticleVariance
			{
				mSizeXVar = Common._M(10),
				mSpinVar = Common.DegreesToRadians((float)Common._M(50))
			});
		...
		// Token: 0x06000E44 RID: 3652 RVA: 0x00090CFC File Offset: 0x0008EEFC
		protected void DrawGlowingRings(SexyGraphics g, float size, float yoff, float ring_xoff, float ring_yoff, Color c1, Color c2, Color c3)
		{
		...
		// Token: 0x06000E45 RID: 3653 RVA: 0x00090F38 File Offset: 0x0008F138
		...
		// Token: 0x06000E46 RID: 3654 RVA: 0x00090F94 File Offset: 0x0008F194
		protected override bool CanFire()
		{
			return this.mTutorialState == 0;
		}

		// Token: 0x06000E47 RID: 3655 RVA: 0x00090F9F File Offset: 0x0008F19F
		protected override bool CanTaunt()
		{
			return this.mTutorialState == 0 && base.CanTaunt();
		}

		// Token: 0x06000E48 RID: 3656 RVA: 0x00090FB1 File Offset: 0x0008F1B1
		protected override bool CanRetaliate()
		{
			return this.mTutorialState == 0;
		}

		// Token: 0x06000E49 RID: 3657 RVA: 0x00090FBC File Offset: 0x0008F1BC
		protected override bool CanDecTikiHealthSpawnAmt()
		{
			return this.mTutorialState == 0;
		}

		// Token: 0x06000E4A RID: 3658 RVA: 0x00090FC8 File Offset: 0x0008F1C8
		protected override void ResetWallAndTikis(int wall_index)
		{
			...
			if (this.mWalls.Count == this.mTikis.Count)
			{
				...
				if (this.mHP > 0f && this.mTutorialState == 0 && (this.mTauntQueue.Count == 0 || !string.Equals(Common.back<TauntText>(this.mTauntQueue).mText, @string)) && this.mHP < 100f)
				{
					this.mTauntQueue.Clear();
					TauntText tauntText = new TauntText();
					this.mTauntQueue.Add(tauntText);
		...
		// Token: 0x06000E4B RID: 3659 RVA: 0x000910E5 File Offset: 0x0008F2E5
		...
		// Token: 0x06000E4C RID: 3660 RVA: 0x0009111F File Offset: 0x0008F31F
		public BossDoctor() : base(null)
		{
			this.Initialize();
		}

		// Token: 0x06000E4D RID: 3661 RVA: 0x00091150 File Offset: 0x0008F350
		public BossDoctor(Level l) : base(l)
		{
			this.Initialize();
		}

		// Token: 0x06000E4E RID: 3662 RVA: 0x00091184 File Offset: 0x0008F384
		...
		// Token: 0x06000E4F RID: 3663 RVA: 0x000912DC File Offset: 0x0008F4DC
		public override void Dispose()
		{
			base.Dispose();
		}

		// Token: 0x06000E50 RID: 3664 RVA: 0x000912E4 File Offset: 0x0008F4E4
		public override void Update()
		{
			this.Update(1f);
		}

		// Token: 0x06000E51 RID: 3665 RVA: 0x000912F4 File Offset: 0x0008F4F4
		public override void Update(float f)
		{
			...
			for (int i = 0; i < this.mParticles.Count; i++)
			{
				...
				else if (bossBulletParticleSystem.mBulletId == -1)
				{
					...
					float num7 = 0f;
					float num8 = 0f;
					float num9 = Common._M(10f);
					if (!Common._eq(bossBulletParticleSystem.mSystem.GetLastX(), (float)centerX, 0.1f))
					{
						num7 = ((float)centerX - bossBulletParticleSystem.mSystem.GetLastX()) / num9;
					}
					if (!Common._eq(bossBulletParticleSystem.mSystem.GetLastY(), (float)centerY, 0.1f))
					{
						num8 = ((float)centerY - bossBulletParticleSystem.mSystem.GetLastY()) / num9;
					}
					bossBulletParticleSystem.mSystem.Move(num7, num8);
				}
			...
			for (int k = 0; k < Common.size<BossBulletParticleSystem>(this.mParticles); k++)
			{
		...
		// Token: 0x06000E52 RID: 3666 RVA: 0x00091994 File Offset: 0x0008FB94
		public override void SyncState(DataSync sync)
		{
			...
			if (sync.isWrite())
			{
				...
				buffer.WriteLong((long)Common.size<PIEffect>(this.mShieldZaps));
				for (int k = 0; k < Common.size<PIEffect>(this.mShieldZaps); k++)
				{
		...
		// Token: 0x06000E53 RID: 3667 RVA: 0x00091C78 File Offset: 0x0008FE78
		public override void DrawTopLevel(SexyGraphics g)
		{
			base.DrawTopLevel(g);
		...
		// Token: 0x06000E54 RID: 3668 RVA: 0x00091D48 File Offset: 0x0008FF48
		...
		// Token: 0x06000E55 RID: 3669 RVA: 0x00091F5C File Offset: 0x0009015C
		...
		// Token: 0x06000E56 RID: 3670 RVA: 0x00091FA4 File Offset: 0x000901A4
		...
		// Token: 0x06000E57 RID: 3671 RVA: 0x000920E4 File Offset: 0x000902E4
