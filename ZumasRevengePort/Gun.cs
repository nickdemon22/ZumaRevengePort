...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000AA8 RID: 2728 RVA: 0x0005F148 File Offset: 0x0005D348
		public static void PreLayerDraw(SexyGraphics g, Layer l, object data)
		{
			Gun gun = (Gun)data;
			gun.SickFrogPreLayerDraw(g, l);
		}

		// Token: 0x06000AA9 RID: 2729 RVA: 0x0005F164 File Offset: 0x0005D364
		public void PopAnimPlaySample(string theSampleName, int thePan, double theVolume, double theNumSteps)
		{
		}

		// Token: 0x06000AAA RID: 2730 RVA: 0x0005F166 File Offset: 0x0005D366
		public PIEffect PopAnimLoadParticleEffect(string theEffectName)
		{
			return null;
		}

		// Token: 0x06000AAB RID: 2731 RVA: 0x0005F169 File Offset: 0x0005D369
		...
		// Token: 0x06000AAC RID: 2732 RVA: 0x0005F16C File Offset: 0x0005D36C
		...
		// Token: 0x06000AAD RID: 2733 RVA: 0x0005F16F File Offset: 0x0005D36F
		...
		// Token: 0x06000AAE RID: 2734 RVA: 0x0005F172 File Offset: 0x0005D372
		...
		// Token: 0x06000AAF RID: 2735 RVA: 0x0005F1A2 File Offset: 0x0005D3A2
		public void PopAnimCommand(int theId, string theCommand, string theParam)
		{
		}

		// Token: 0x06000AB0 RID: 2736 RVA: 0x0005F1A4 File Offset: 0x0005D3A4
		...
		// Token: 0x06000AB1 RID: 2737 RVA: 0x0005F1B4 File Offset: 0x0005D3B4
		...
		// Token: 0x06000AB2 RID: 2738 RVA: 0x0005F204 File Offset: 0x0005D404
		protected void CalcAngle()
		{
			...
			if (this.mState == GunState.GunState_Reloading && Common.gSuckMode && (this.mBX != 0 || this.mBY != 0))
			{
		...
		// Token: 0x06000AB3 RID: 2739 RVA: 0x0005F338 File Offset: 0x0005D538
		...
		// Token: 0x06000AB4 RID: 2740 RVA: 0x0005F394 File Offset: 0x0005D594
		protected void UpdateCannonFadeIn()
		{
			if (this.mCannonState == 1)
			{
				this.mCannonRuneAlpha += (int)Common._M(15f);
			...
			{
				this.mCannonLightness += (int)Common._M(5f);
			...
			{
				this.mCannonLightness -= (int)Common._M(10f);
		...
		// Token: 0x06000AB5 RID: 2741 RVA: 0x0005F468 File Offset: 0x0005D668
		...
		// Token: 0x06000AB6 RID: 2742 RVA: 0x0005F4E0 File Offset: 0x0005D6E0
		protected void SetFrogType(FrogType t, bool current)
		{
			...
			if (t == FrogType.FrogType_Normal)
			{
				...
				frogBody.mMouthOffset = new Point(Common._M(26), (t == FrogType.FrogType_Normal) ? ((int)Common._M1(79f)) : 82);
				if (t == FrogType.FrogType_Normal)
				{
					frogBody.mLegsOffset = new Point(Common._M(2), (int)Common._M1(38f));
					this.mBallYOff = (int)Common._M(0f);
				}
				else
				{
					frogBody.mLegsOffset = new Point(1, (int)Common._M(41f));
				}
				frogBody.mBodyOffset = new Point((int)Common._M(16f), (int)Common._M1(4f));
				frogBody.mEyesOffset = new Point(32, (int)Common._M(47f));
				this.mCannonState = -1;
				if (t == FrogType.FrogType_Lightning)
				{
			...
			else
			{
				if (t == FrogType.FrogType_Lightning)
				{
					...
					frogBody.mLegsOffset = new Point((int)Common._M(11f), (int)Common._M1(78f));
					frogBody.mBodyOffset = new Point((int)Common._M(0f), (int)Common._M1(0f));
					frogBody.mEyesOffset = new Point((int)Common._M(32f), (int)Common._M1(47f));
					this.mCannonState = -1;
					if (!GameApp.gApp.GetBoard().IsLoading())
					{
						GameApp.gApp.PlaySample(Res.GetSoundByID(ResID.SOUND_LIGHTNING_TRIGGER));
				...
				if (t == FrogType.FrogType_Lazer)
				{
					...
					frogBody.mBodyOffset = new Point((int)Common._M(0f), (int)Common._M1(6f));
					frogBody.mEyesOffset = new Point((int)Common._M(31f), (int)Common._M1(45f));
				...
				if (t == FrogType.FrogType_Cannon)
				{
					...
					frogBody.mMouthOffset = new Point((int)Common._M(26f), (int)Common._M1(74f));
		...
		// Token: 0x06000AB7 RID: 2743 RVA: 0x0005FAD4 File Offset: 0x0005DCD4
		protected void DrawFrogBase(SexyGraphics g, FrogBody fb)
		{
			int num = fb.mAlpha;
			...
			if (g.Is3D())
			{
				g.DrawImageRotatedF(fb.mShadow, (float)Common._S(num2 + Common._M(-2)), Common._S((float)num3 - this.mRecoilAmt / 2f + (float)Common._M1(3)), (double)this.mAngle, (float)Common._S(fb.mCX), Common._S((float)fb.mCY + this.mRecoilAmt / 2f), celRect);
			}
			else
			{
				g.DrawImageRotated(fb.mShadow, Common._S(num2 + Common._M(-2)), (int)Common._S((float)num3 - this.mRecoilAmt / 2f + (float)Common._M1(3)), (double)this.mAngle, Common._S(fb.mCX), (int)Common._S((float)fb.mCY + this.mRecoilAmt / 2f), celRect);
			}
			...
			if (fb.mLegs != null)
			{
				...
				if (g.Is3D())
				{
					g.DrawImageRotated(fb.mLegs, Common._S(num2 + fb.mLegsOffset.mX), Common._S(num3 + fb.mLegsOffset.mY), (double)this.mAngle, Common._S(fb.mCX - fb.mLegsOffset.mX), Common._S(fb.mCY - fb.mLegsOffset.mY), celRect);
				}
				else
				{
					g.DrawImageRotated(fb.mLegs, Common._S(num2 + fb.mLegsOffset.mX), Common._S(num3 + fb.mLegsOffset.mY), (double)this.mAngle, Common._S(fb.mCX - fb.mLegsOffset.mX), Common._S(fb.mCY - fb.mLegsOffset.mY), celRect);
			...
			if (fb.mMouth != null)
			{
				...
				if (this.mBossStateAlpha > 0f)
				{
					g.PushState();
					g.SetColorizeImages(true);
					int num6 = (int)(255f - this.mBossStateAlpha);
					num6 = Math.Min(Math.Max(0, num), 255);
					g.SetColor(255, 255, 255, num6);
				}
				celRect = fb.mMouth.GetCelRect(num5);
				if (g.Is3D())
				{
					g.DrawImageRotatedF(fb.mMouth, (float)Common._S(num2 + fb.mMouthOffset.mX), Common._S((float)(num3 + fb.mMouthOffset.mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - fb.mMouthOffset.mX), Common._S((float)(fb.mCY - fb.mMouthOffset.mY) + this.mRecoilAmt), celRect);
				}
				else
				{
					g.DrawImageRotated(fb.mMouth, Common._S(num2 + fb.mMouthOffset.mX), (int)Common._S((float)(num3 + fb.mMouthOffset.mY) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - fb.mMouthOffset.mX), (int)Common._S((float)(fb.mCY - fb.mMouthOffset.mY) + this.mRecoilAmt), celRect);
				}
				if (this.mBossStateAlpha > 0f)
				{
					g.PopState();
					...
					{
						new Point(Common._M(42), Common._M1(16)),
						new Point(Common._M2(42), Common._M3(16))
					};
					int mX = array2[this.mBossState].mX;
					int mY = array2[this.mBossState].mY;
					if (g.Is3D())
					{
						g.DrawImageRotatedF(array[this.mBossState], (float)Common._S(num2 + mX), Common._S((float)(num3 + mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - mX), Common._S((float)(fb.mCY - mY) + this.mRecoilAmt));
					}
					else
					{
						g.DrawImageRotatedF(array[this.mBossState], (float)Common._S(num2 + mX), Common._S((float)(num3 + mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - mX), Common._S((float)(fb.mCY - mY) + this.mRecoilAmt));
		...
		// Token: 0x06000AB8 RID: 2744 RVA: 0x00060118 File Offset: 0x0005E318
		protected void DrawFrogTongue(SexyGraphics g, FrogBody fb)
		{
			...
			if (g.Is3D())
			{
				g.DrawImageRotatedF(fb.mTongue, (float)Common._S(num3 + fb.mTongueX), Common._S((float)(num4 + num2) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - fb.mTongueX), Common._S((float)(fb.mCY - num2) + this.mRecoilAmt));
			}
			else
			{
				g.DrawImageRotated(fb.mTongue, Common._S(num3 + fb.mTongueX), (int)Common._S((float)(num4 + num2) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - fb.mTongueX), (int)Common._S((float)(fb.mCY - num2) + this.mRecoilAmt));
			}
			g.PopState();
		}

		// Token: 0x06000AB9 RID: 2745 RVA: 0x00060314 File Offset: 0x0005E514
		protected void DrawFrogTop(SexyGraphics g, FrogBody fb)
		{
			...
			else if (Common.size<FrogBody>(this.mFrogStack) > 0 && Common.back<FrogBody>(this.mFrogStack).mAlpha > 0)
			{
				g.SetColor(255, 255, 255, 255 - Common.back<FrogBody>(this.mFrogStack).mAlpha);
				g.SetColorizeImages(true);
			}
			if (this.mBossStateAlpha > 0f)
			{
			...
			if (g.Is3D())
			{
				g.DrawImageRotatedF(fb.mBody, (float)Common._S(num + fb.mBodyOffset.mX), Common._S((float)(num2 + fb.mBodyOffset.mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - fb.mBodyOffset.mX), Common._S((float)(fb.mCY - fb.mBodyOffset.mY) + this.mRecoilAmt));
			}
			else
			{
				g.DrawImageRotated(fb.mBody, Common._S(num + fb.mBodyOffset.mX), (int)Common._S((float)(num2 + fb.mBodyOffset.mY) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - fb.mBodyOffset.mX), (int)Common._S((float)(fb.mCY - fb.mBodyOffset.mY) + this.mRecoilAmt));
			}
			if (GameApp.gApp.mBoard != null && GameApp.gApp.mBoard.mIsHotFrogEnabled)
			{
				g.SetColorizeImages(false);
			...
			if (Common.size<FrogBody>(this.mFrogStack) > 0 && Common.back<FrogBody>(this.mFrogStack).mAlpha > 0)
			{
				g.SetColorizeImages(false);
			}
			if (this.mBossStateAlpha > 0f)
			{
				...
				Point[] array2 = new Point[]
				{
					new Point(Common._M(0), Common._M1(4)),
					new Point(Common._M2(0), Common._M3(4))
				};
				int mX = array2[this.mBossState].mX;
				int mY = array2[this.mBossState].mY;
				if (g.Is3D())
				{
					g.DrawImageRotatedF(array[this.mBossState], (float)Common._S(num + mX), Common._S((float)(num2 + mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - mX), Common._S((float)(fb.mCY - mY) + this.mRecoilAmt));
				}
				else
				{
					g.DrawImageRotatedF(array[this.mBossState], (float)Common._S(num + mX), Common._S((float)(num2 + mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - mX), Common._S((float)(fb.mCY - mY) + this.mRecoilAmt));
			...
			if (fb.mType == FrogType.FrogType_Cannon)
			{
				if (this.mState == GunState.GunState_Reloading)
				{
					...
					if (g.Is3D())
					{
						g.DrawImageRotatedF(fb.mMouth, (float)Common._S(num + fb.mMouthOffset.mX), Common._S((float)(num2 + fb.mMouthOffset.mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - fb.mMouthOffset.mX), Common._S((float)(fb.mCY - fb.mMouthOffset.mY) + this.mRecoilAmt), celRect);
					}
					else
					{
						g.DrawImageRotated(fb.mMouth, Common._S(num + fb.mMouthOffset.mX), (int)Common._S((float)(num2 + fb.mMouthOffset.mY) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - fb.mMouthOffset.mX), (int)Common._S((float)(fb.mCY - fb.mMouthOffset.mY) + this.mRecoilAmt), celRect);
					}
				}
			}
			else if (fb.mType == FrogType.FrogType_Lightning)
			{
				float num5 = (float)(Common._M(50) + fb.mBodyOffset.mX);
				float num6 = (float)(Common._M(-6) + fb.mBodyOffset.mY);
				int num7 = Common.GetAlphaFromUpdateCount(this.mUpdateCount, Common._M(64)) * Common._M1(4);
				if (num7 > 255)
				{
					num7 = 255;
				}
				if (g.Is3D())
				{
					...
					g.DrawImageRotatedF(Res.GetImageByID(ResID.IMAGE_FROG_BOLT), Common._S((float)num + num5), Common._S((float)num2 + num6 - this.mRecoilAmt), (double)this.mAngle, Common._S((float)fb.mCX - num5), Common._S((float)fb.mCY - num6 + this.mRecoilAmt));
					g.SetColorizeImages(false);
					g.SetDrawMode(0);
				}
				else
				{
					g.DrawImageRotated(Res.GetImageByID(ResID.IMAGE_FROG_BOLT), (int)Common._S((float)num + num5), (int)Common._S((float)num2 + num6 - this.mRecoilAmt), (double)this.mAngle, (int)Common._S((float)fb.mCX - num5), (int)Common._S((float)fb.mCY - num6 + this.mRecoilAmt));
				}
			}
			if ((this.mState != GunState.GunState_Normal || this.IsStunned() || this.mBlinkCount >= 0) && fb.mEyes != null && fb.mEyes.mNumRows > 1 && this.mBossStateAlpha <= 0f)
			{
				...
				if (num8 >= 0)
				{
					...
					if (g.Is3D())
					{
						g.DrawImageRotatedF(fb.mEyes, (float)Common._S(num + fb.mEyesOffset.mX), Common._S((float)(num2 + fb.mEyesOffset.mY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - fb.mEyesOffset.mX), Common._S((float)(fb.mCY - fb.mEyesOffset.mY) + this.mRecoilAmt), celRect2);
					}
					else
					{
						g.DrawImageRotated(fb.mEyes, Common._S(num + fb.mEyesOffset.mX), (int)Common._S((float)(num2 + fb.mEyesOffset.mY) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - fb.mEyesOffset.mX), (int)Common._S((float)(fb.mCY - fb.mEyesOffset.mY) + this.mRecoilAmt), celRect2);
					}
				}
			}
			else if (fb.mType == FrogType.FrogType_Lazer)
			{
				bool flag = fb == this.mCurrentBody && Common.size<FrogBody>(this.mFrogStack) > 0 && Common.back<FrogBody>(this.mFrogStack).mAlpha > 0 && Common.back<FrogBody>(this.mFrogStack).mType != this.mCurrentBody.mType;
				int num9 = 0;
				if (flag)
				{
					num9 = 255 - Common.back<FrogBody>(this.mFrogStack).mAlpha;
				}
				...
				int num11 = Common._M(0);
				int num12 = Common._M(-4);
				...
				int num13 = Common._M(19);
				int num14 = Common._M(33);
				g.SetColorizeImages(true);
				g.SetDrawMode(1);
				...
				if (g.Is3D())
				{
					g.DrawImageRotatedF(fb.mLazerEyeLoop, (float)Common._S(num + num13), Common._S((float)(num2 + num14) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - num13), Common._S((float)(fb.mCY - num14) + this.mRecoilAmt), rect);
				}
				else
				{
					g.DrawImageRotated(fb.mLazerEyeLoop, Common._S(num + num13), (int)Common._S((float)(num2 + num14) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - num13), (int)Common._S((float)(fb.mCY - num14) + this.mRecoilAmt), rect);
				}
				g.PopState();
				if (flag)
				{
				...
				if (num16 < num15)
				{
					rect = imageByID.GetCelRect(num16);
					if (g.Is3D())
					{
						g.DrawImageRotatedF(imageByID, (float)Common._S(num + num11), Common._S((float)(num2 + num12) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - num11), Common._S((float)(fb.mCY - num12) + this.mRecoilAmt), rect);
					}
					else
					{
						g.DrawImageRotated(imageByID, Common._S(num + num11), (int)Common._S((float)(num2 + num12) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - num11), (int)Common._S((float)(fb.mCY - num12) + this.mRecoilAmt), rect);
					}
				}
				g.SetColorizeImages(false);
				...
				for (int i = 0; i < 4; i++)
				{
					if (this.mLazerFrogBackPulseAlpha[i] != 0f)
					{
						...
						num11 = Common._M(40) + Common._DS(Res.GetOffsetXByID(ResID.IMAGE_FROG_BACKPULSE));
						num12 = Common._M(6) + Common._DS(Res.GetOffsetXByID(ResID.IMAGE_FROG_BACKPULSE));
						if (g.Is3D())
						{
							g.DrawImageRotatedF(imageByID2, (float)Common._S(num + num11), Common._S((float)(num2 + num12) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - num11), Common._S((float)(fb.mCY - num12) + this.mRecoilAmt), rect);
						}
						else
						{
							g.DrawImageRotated(imageByID2, Common._S(num + num11), (int)Common._S((float)(num2 + num12) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - num11), (int)Common._S((float)(fb.mCY - num12) + this.mRecoilAmt), rect);
						}
						g.SetColorizeImages(false);
						g.SetDrawMode(0);
					}
			...
			{
				int num17 = Common._M(0);
				int num18 = Common._M(-8);
				g.PushState();
				if (fb.mType != FrogType.FrogType_Lazer)
				{
					...
					if (g.Is3D())
					{
						g.DrawImageRotatedF(imageByID3, (float)Common._S(num + num17), Common._S((float)(num2 + num18) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(fb.mCX - num17), Common._S((float)(fb.mCY - num18) + this.mRecoilAmt));
					}
					else
					{
						g.DrawImageRotated(imageByID3, Common._S(num + num17), (int)Common._S((float)(num2 + num18) - this.mRecoilAmt), (double)this.mAngle, Common._S(fb.mCX - num17), (int)Common._S((float)(fb.mCY - num18) + this.mRecoilAmt));
					}
				}
				g.PopState();
			}
		...
		// Token: 0x06000ABA RID: 2746 RVA: 0x000611F9 File Offset: 0x0005F3F9
		protected float GetBeamAngle()
		{
			return this.GetAngle() - 1.570795f;
		}

		// Token: 0x06000ABB RID: 2747 RVA: 0x00061208 File Offset: 0x0005F408
		protected void UpdateBeamVec(List<BeamComponent> v, bool remove)
		{
			for (int i = 0; i < Common.size<BeamComponent>(v); i++)
			{
		...
		// Token: 0x06000ABC RID: 2748 RVA: 0x0006137B File Offset: 0x0005F57B
		protected void UpdateBeamVec(List<BeamComponent> v)
		{
			this.UpdateBeamVec(v, true);
		}

		// Token: 0x06000ABD RID: 2749 RVA: 0x00061388 File Offset: 0x0005F588
		protected void DrawBeamVec(SexyGraphics g, List<BeamComponent> v, bool overlay)
		{
			for (int i = 0; i < Common.size<BeamComponent>(v); i++)
			{
				BeamComponent beamComponent = v[i];
		...
		// Token: 0x06000ABE RID: 2750 RVA: 0x00061458 File Offset: 0x0005F658
		protected void DrawBeamVec(SexyGraphics g, List<BeamComponent> v)
		{
			this.DrawBeamVec(g, v, false);
		}

		// Token: 0x06000ABF RID: 2751 RVA: 0x00061464 File Offset: 0x0005F664
		...
		// Token: 0x06000AC0 RID: 2752 RVA: 0x0006151C File Offset: 0x0005F71C
		...
		// Token: 0x06000AC1 RID: 2753 RVA: 0x000615EC File Offset: 0x0005F7EC
		...
		// Token: 0x06000AC2 RID: 2754 RVA: 0x000616A8 File Offset: 0x0005F8A8
		protected void StepBeamUpdate(int count, bool remove)
		{
			...
			if (this.mElectricOrb.mVX == 0f && this.mElectricOrb.mVY == 0f)
			{
				...
				if ((float)count % (1f + (float)Common.Rand() % Common._M(6f)) == 0f)
				{
					this.EmitBeamB();
				}
		...
		// Token: 0x06000AC3 RID: 2755 RVA: 0x0006174F File Offset: 0x0005F94F
		protected void StepBeamUpdate(int count)
		{
			this.StepBeamUpdate(count, true);
		}

		// Token: 0x06000AC4 RID: 2756 RVA: 0x0006175C File Offset: 0x0005F95C
		protected bool ShouldRemoveBeamComponent(BeamComponent bc)
		{
			return (((bc.mX >= this.mBeamProjectedEndX && MathUtils._geq(bc.mVX, 0f)) || (bc.mX <= this.mBeamProjectedEndX && MathUtils._leq(bc.mVX, 0f))) && ((bc.mY >= this.mBeamProjectedEndY && MathUtils._geq(bc.mVY, 0f)) || (bc.mY <= this.mBeamProjectedEndY && MathUtils._leq(bc.mVY, 0f)))) || bc.mDistTraveled > Common._SS(Common._M(1400f));
		}

		// Token: 0x06000AC5 RID: 2757 RVA: 0x00061804 File Offset: 0x0005FA04
		...
		// Token: 0x06000AC6 RID: 2758 RVA: 0x000618B4 File Offset: 0x0005FAB4
		...
		// Token: 0x06000AC7 RID: 2759 RVA: 0x00061998 File Offset: 0x0005FB98
		...
		// Token: 0x06000AC8 RID: 2760 RVA: 0x00061AD8 File Offset: 0x0005FCD8
		protected void DrawBeams(SexyGraphics g)
		{
			...
			g.DrawImageMatrix(this.mElectricOrb.mImage, sexyTransform2D, this.mElectricOrb.mImage.GetCelRect(this.mElectricOrb.mCel), Common._S(this.mElectricOrb.mX), Common._S(this.mElectricOrb.mY));
			g.SetDrawMode(0);
		}

		// Token: 0x06000AC9 RID: 2761 RVA: 0x00061BE8 File Offset: 0x0005FDE8
		protected void UpdateBeams()
		{
			this.StepBeamUpdate(this.mUpdateCount);
			if (this.mUpdateCount % Common._M(6) == 0)
			{
		...
		// Token: 0x06000ACA RID: 2762 RVA: 0x00061CAC File Offset: 0x0005FEAC
		protected void RetargetBeams(float angle_delta)
		{
			...
			this.mElectricOrb.mX = (float)this.GetCenterX() + num3 * (this.mElectricOrb.mDistTraveled + Common._M(20f));
			this.mElectricOrb.mY = (float)this.GetCenterY() - num4 * (this.mElectricOrb.mDistTraveled + Common._M(20f));
		}

		// Token: 0x06000ACB RID: 2763 RVA: 0x00061E1C File Offset: 0x0006001C
		protected void DoBubbles(int num)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				bubble.Init((float)Common._M(0), MathUtils.FloatRange(Common._M1(-1.2f), Common._M2(-0.5f)), MathUtils.FloatRange(Common._M3(0.05f), Common._M4(0.2f)), (int)MathUtils.FloatRange(Common._M5(15f), Common._M6(25f)));
				bubble.SetAlphaFade(Common._M(2f));
				float num2 = this.mCurX - (float)this.mCurrentBody.mCX + (float)this.mCurrentBody.mTongueX + (float)MathUtils.IntRange((int)Common._M(0f), (int)Common._M1(20f));
				float num3 = this.mCurY - (float)this.mCurrentBody.mCY + (float)Gun.TONGUE_Y2 + (float)Common._M(0);
				num2 += (float)Math.Cos((double)this.mAngle - 1.5707950592041016) * (float)MathUtils.IntRange((int)Common._M(30f), (int)Common._M1(50f));
				num3 -= (float)Math.Sin((double)this.mAngle - 1.5707950592041016) * (float)MathUtils.IntRange((int)Common._M(30f), (int)Common._M1(50f));
				bubble.SetX(num2);
				bubble.SetY(num3);
		...
		// Token: 0x06000ACC RID: 2764 RVA: 0x00061FD4 File Offset: 0x000601D4
		public Gun(Board b)
		{
			this.mBoard = b;
			for (int i = 0; i < 4; i++)
			...
			this.mLazer.Create(Common._S(20), Common._S(1000));
			SexyGraphics graphics = new SexyGraphics(this.mLazer);
			graphics.SetColor(0, 0, 0, 0);
			graphics.FillRect(0, 0, this.mLazer.mWidth, this.mLazer.mHeight);
			for (int j = 0; j < this.mLazer.mHeight; j += Common._S(2))
			{
		...
		// Token: 0x06000ACD RID: 2765 RVA: 0x00062508 File Offset: 0x00060708
		...
		// Token: 0x06000ACE RID: 2766 RVA: 0x000625B6 File Offset: 0x000607B6
		public bool NeedsReload()
		{
			return this.mNextBullet == null || this.mBullet == null;
		}

		// Token: 0x06000ACF RID: 2767 RVA: 0x000625CB File Offset: 0x000607CB
		...
		// Token: 0x06000AD0 RID: 2768 RVA: 0x000625E8 File Offset: 0x000607E8
		...
		// Token: 0x06000AD1 RID: 2769 RVA: 0x00062624 File Offset: 0x00060824
		...
		// Token: 0x06000AD2 RID: 2770 RVA: 0x000626F0 File Offset: 0x000608F0
		public void SickFrogPreLayerDraw(SexyGraphics g, Layer l)
		{
			...
			if (this.mShowNextBall && this.mBoard.mLevel.mBoss.AllowFrogToFire() && this.mNextBullet != null && this.mState != GunState.GunState_Reloading && Common.StrFindNoCase(l.mLayerName, "top") != -1)
			{
				if (this.mBullet != null)
				{
					this.mBullet.Draw(g, this.mBallXOff + GameApp.gScreenShakeX - Common._DS(Common._M(3)), this.mBallYOff + GameApp.gScreenShakeY);
				}
				Image imageByID = Res.GetImageByID(ResID.IMAGE_NEXT_BALL);
				int num3 = this.mNextBullet.GetColorType();
				...
				Rect celRect = imageByID.GetCelRect(num3);
				if (g.Is3D())
				{
					g.DrawImageRotatedF(imageByID, (float)Common._S(num + this.mCurrentBody.mNextBallX), Common._S((float)(num2 + this.mCurrentBody.mNextBallY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(this.mCurrentBody.mCX - this.mCurrentBody.mNextBallX), Common._S((float)(this.mCurrentBody.mCY - this.mCurrentBody.mNextBallY) + this.mRecoilAmt), celRect);
					return;
				}
				g.DrawImageRotated(imageByID, Common._S(num + this.mCurrentBody.mNextBallX), (int)Common._S((float)(num2 + this.mCurrentBody.mNextBallY) - this.mRecoilAmt), (double)this.mAngle, Common._S(this.mCurrentBody.mCX - this.mCurrentBody.mNextBallX), (int)Common._S((float)(this.mCurrentBody.mCY - this.mCurrentBody.mNextBallY) + this.mRecoilAmt), celRect);
			}
		}

		// Token: 0x06000AD3 RID: 2771 RVA: 0x0006291A File Offset: 0x00060B1A
		public void DoInkedState()
		{
			this.mBossStateAlphaDir = 1;
			this.mBossStateHoldTimer = Common._M(500);
			this.mBossState = 0;
		}

		// Token: 0x06000AD4 RID: 2772 RVA: 0x0006293A File Offset: 0x00060B3A
		public void DoPlaguedState()
		{
			this.mBossStateAlphaDir = 1;
			this.mBossStateHoldTimer = Common._M(300);
			this.mBossState = 1;
		}

		// Token: 0x06000AD5 RID: 2773 RVA: 0x0006295C File Offset: 0x00060B5C
		public void DrawConfusionMarks(SexyGraphics g)
		{
			...
			g.SetColorizeImages(true);
			for (int i = 0; i < Common.size<ConfusionMark>(this.mConfusionMarks); i++)
			{
				ConfusionMark confusionMark = this.mConfusionMarks[i];
				g.SetColor(255, 255, 255, (int)confusionMark.mAlpha);
				g.DrawImage(confusionMark.mImage, (int)Common._S(confusionMark.mX + (float)this.GetCenterX()), (int)Common._S(confusionMark.mY + (float)this.GetCenterY()), (int)(confusionMark.mSize * (float)confusionMark.mImage.mWidth), (int)(confusionMark.mSize * (float)confusionMark.mImage.mHeight));
			}
			g.SetColorizeImages(false);
		}

		// Token: 0x06000AD6 RID: 2774 RVA: 0x00062A28 File Offset: 0x00060C28
		public void MoveToBossDeathPosition(float x, float y)
		{
			this.mBossDeathTX = x;
			this.mBossDeathTY = y;
			this.mBossDeathVX = (x - this.mCurX) / Common._M(200f);
			this.mBossDeathVY = (y - this.mCurY) / Common._M(200f);
		}

		// Token: 0x06000AD7 RID: 2775 RVA: 0x00062A78 File Offset: 0x00060C78
		...
		// Token: 0x06000AD8 RID: 2776 RVA: 0x00062B20 File Offset: 0x00060D20
		public void Reload(int theType)
		{
			this.Reload(theType, false, PowerType.PowerType_Max);
		}

		// Token: 0x06000AD9 RID: 2777 RVA: 0x00062B2C File Offset: 0x00060D2C
		...
		// Token: 0x06000ADA RID: 2778 RVA: 0x00062BAB File Offset: 0x00060DAB
		public void Reload2(int theType)
		{
			this.Reload2(theType, false, PowerType.PowerType_Max, 0, 0);
		}

		// Token: 0x06000ADB RID: 2779 RVA: 0x00062BBC File Offset: 0x00060DBC
		public void Reload3()
		{
		...
		// Token: 0x06000ADC RID: 2780 RVA: 0x00062C14 File Offset: 0x00060E14
		...
		// Token: 0x06000ADD RID: 2781 RVA: 0x00062C6C File Offset: 0x00060E6C
		...
		// Token: 0x06000ADE RID: 2782 RVA: 0x00062C90 File Offset: 0x00060E90
		...
		// Token: 0x06000ADF RID: 2783 RVA: 0x00062D1C File Offset: 0x00060F1C
		public void SetDestPos(int x, int y, int theSpeed, bool doingHop)
		{
			...
			sexyVector = new SexyVector2((float)(this.mDestX2 - this.mDestX1), (float)(this.mDestY2 - this.mDestY1));
			...
			{
				this.DoBubbles((int)Common._M(5f));
			}
		}

		// Token: 0x06000AE0 RID: 2784 RVA: 0x00062DFD File Offset: 0x00060FFD
		public void SetDestPos(int x, int y, int theSpeed)
		{
			this.SetDestPos(x, y, theSpeed, false);
		}

		// Token: 0x06000AE1 RID: 2785 RVA: 0x00062E0C File Offset: 0x0006100C
		public void Draw(SexyGraphics g, int clip_height)
		{
			...
			if (this.mBullet != null && this.GetType() == 1 && !this.mBoard.IsPaused() && !this.mBoard.LevelIsSkeletonBoss())
			{
				...
				int num10 = (int)Common._S(this.mBullet.GetX() + (float)this.mBallXOff);
				int num11 = (int)Common._S(this.mBullet.GetY() + (float)this.mBallYOff);
				...
				if (g.Get3D() == null)
				{
					Point point = new Point((int)((float)Common._S(Common._M(1000)) * num6 + (float)num10), (int)((float)Common._S(Common._M1(1000)) * num7 + (float)num11));
					Point point2 = new Point((int)((float)Common._S(Common._M(1000)) * num8 + (float)num10), (int)((float)Common._S(Common._M1(1000)) * num9 + (float)num11));
				...
				if (!g.Is3D())
				{
					...
					for (int j = 0; j < Gun.NUM_CANNON_SHADOWS; j++)
					{
						...
						{
							g.SetColor(Common._M(128), Common._M1(128), Common._M2(128), this.mCannonBallShadows[j]);
							for (int k = 0; k < 3; k++)
							{
								g.DrawImage(imageByID, (int)((float)(num10 - imageByID.mWidth / 2) + this.mVels[k].mX * (float)(j + 1) * (float)Common._S(Common._M(80))), (int)((float)(num11 - imageByID.mHeight / 2) + this.mVels[k].mY * (float)(j + 1) * (float)Common._S(Common._M(80))));
							}
						}
					}
					g.SetColorizeImages(false);
			...
			if ((this.mStunTimer > 0 && this.mBlinkCount < 0) || this.mFlameStun != null || this.mDarkFrogStun != null)
			{
				...
				else
				{
					...
					g.DrawImageRotated(imageByID2, (int)(Common._S(this.mCenterX) - (float)(celRect.mWidth / 2) + (float)Common._M(0)), (int)(Common._S(this.mCenterY) - (float)(celRect.mHeight / 2)), (double)this.mAngle, celRect);
				}
			}
			else if (!this.IsPoisoned())
			{
				...
				if (clip_height != 0)
				{
					g.ClipRect(0, 0, GameApp.gApp.mWidth, (int)Common._S(this.mCenterY + (float)this.mHeight + (float)clip_height));
				}
				this.DrawFrogBase(g, this.mCurrentBody);
				for (int l = 0; l < Common.size<FrogBody>(this.mFrogStack); l++)
				{
				...
				for (int m = 0; m < Common.size<FrogBody>(this.mFrogStack); m++)
				{
			...
			else
			{
				...
				Common._S(this.mCenterX - this.mCurX);
				if (g.Is3D())
				{
					g.DrawImageRotatedF(this.mCurrentBody.mShadow, (float)Common._S(num + Common._M(-2)), Common._S((float)num2 - this.mRecoilAmt / 2f + (float)Common._M1(3)), (double)this.mAngle, (float)Common._S(this.mCurrentBody.mCX), Common._S((float)this.mCurrentBody.mCY + this.mRecoilAmt / 2f), celRect2);
				}
				else
				{
					g.DrawImageRotated(this.mCurrentBody.mShadow, Common._S(num + Common._M(-2)), (int)Common._S((float)num2 - this.mRecoilAmt / 2f + (float)Common._M1(3)), (double)this.mAngle, Common._S(this.mCurrentBody.mCX), (int)Common._S((float)this.mCurrentBody.mCY + this.mRecoilAmt / 2f), celRect2);
				}
				float num12 = Common._S(this.mCurX) + (float)Common._DS(Common._M(0));
				float num13 = Common._S(this.mCurY) + (float)Common._DS(Common._M(8));
				this.mCumTran.Reset();
				this.mCumTran.mTrans.Translate((float)(-(float)this.mSickAnim.mWidth) * Common._DS(1f), (float)(-(float)this.mSickAnim.mHeight) * Common._DS(1f));
				this.mCumTran.mTrans.RotateRad(this.mAngle);
				this.mCumTran.mTrans.Translate(num12, num13);
				this.mSickAnim.Draw(g, this.mCumTran, -1, Common._DS(1f));
			}
			if (this.mSpitAlpha > 0f && this.mFlameStun == null && this.mDarkFrogStun == null)
			{
				...
				this.mGlobalTranform.RotateRad(this.mSpitAngle - 3.1415927f * Common._M(0.5f));
				g.DrawImageTransform(Res.GetImageByID(ResID.IMAGE_FROG_SLOBBER), this.mGlobalTranform, Common._S(this.mSpitX), Common._S(this.mSpitY));
				g.SetColorizeImages(false);
			}
			...
			if ((this.mStunTimer <= 0 || (this.mBlinkCount >= 0 && this.mFlameStun == null && this.mDarkFrogStun == null)) && !this.IsPoisoned())
			{
				...
				g.DrawImageRotated(Res.GetImageByID(ResID.IMAGE_FROG_BALLBACK), Common._S(num + this.mCurrentBody.mNextBallX), (int)Common._S((float)(num2 + this.mCurrentBody.mNextBallY) - this.mRecoilAmt), (double)this.mAngle, Common._S(this.mCurrentBody.mCX - this.mCurrentBody.mNextBallX), (int)Common._S((float)(this.mCurrentBody.mCY - this.mCurrentBody.mNextBallY) + this.mRecoilAmt));
				if (this.mShowNextBall && (this.mBoard.mLevel.mBoss == null || this.mBoard.mLevel.mBoss.AllowFrogToFire()) && !this.LaserMode() && !this.LightningMode() && this.mNextBullet != null && (this.mState != GunState.GunState_Reloading || Common.gSuckMode))
				{
					Image imageByID3 = Res.GetImageByID(ResID.IMAGE_NEXT_BALL);
					int num14 = this.mNextBullet.GetColorType();
					if (GameApp.gApp.mColorblind && this.mNextBullet.GetColorType() == 3)
					{
						num14 = 6;
					}
					...
					Rect celRect3 = imageByID3.GetCelRect(num14);
					if (g.Is3D())
					{
						g.DrawImageRotatedF(imageByID3, (float)Common._S(num + this.mCurrentBody.mNextBallX), Common._S((float)(num2 + this.mCurrentBody.mNextBallY) - this.mRecoilAmt), (double)this.mAngle, (float)Common._S(this.mCurrentBody.mCX - this.mCurrentBody.mNextBallX), Common._S((float)(this.mCurrentBody.mCY - this.mCurrentBody.mNextBallY) + this.mRecoilAmt), celRect3);
					}
					else
					{
						g.DrawImageRotated(imageByID3, Common._S(num + this.mCurrentBody.mNextBallX), (int)Common._S((float)(num2 + this.mCurrentBody.mNextBallY) - this.mRecoilAmt), (double)this.mAngle, Common._S(this.mCurrentBody.mCX - this.mCurrentBody.mNextBallX), (int)Common._S((float)(this.mCurrentBody.mCY - this.mCurrentBody.mNextBallY) + this.mRecoilAmt), celRect3);
					}
				}
				this.DrawFrogTop(g, this.mCurrentBody);
				for (int n = 0; n < Common.size<FrogBody>(this.mFrogStack); n++)
				{
			...
			if (this.LaserMode() && !this.mBoard.IsPaused())
			{
				...
				float num15 = this.GetAngle() - 3.14159f;
				this.mGp.mX = (int)Common._S(value);
				this.mGp.mY = (int)Common._S(value2);
				float num16 = (float)(Common._S(this.GetCenterX()) - Common._S(Common._M(24)));
				float num17 = (float)(Common._S(this.GetCenterY()) - Common._S(Common._M(0)));
				Common.RotatePoint(num15, ref num16, ref num17, (float)Common._S(this.GetCenterX()), (float)Common._S(this.GetCenterY()));
				this.mCP.mX = (int)num16;
				this.mCP.mY = (int)num17;
				float num18 = MathUtils.Distance(this.mCP, this.mGp, true);
				float num19 = num18;
				float num20 = num18 * this.mLazerPercent;
				Rect rect;
				rect = new Rect(0, 0, Common._S(20), (int)num20);
				if (num20 > (float)this.mLazer.mHeight)
				{
					num20 = (float)this.mLazer.mHeight;
				}
				rect.mHeight = (int)num20;
				float[] array3 = new float[2];
				array3[0] = CommonMath.AngleBetweenPoints(this.mCP, this.mGp);
				g.SetDrawMode(1);
				if (g.Is3D())
				{
					g.DrawImageRotatedF(this.mLazer, (float)Common._S(this.GetCenterX() - Common._M(32)), (float)Common._S(this.GetCenterY()) - num20, (double)(array3[0] - 1.570795f), (float)Common._S(Common._M1(32)), num20, rect);
				}
				else
				{
					g.DrawImageRotated(this.mLazer, Common._S(this.GetCenterX() - Common._M(32)), (int)((float)Common._S(this.GetCenterY()) - num20), (double)(array3[0] - 1.570795f), Common._S(Common._M1(32)), (int)num20, rect);
				}
				PIEmitterInstance emitter = array2[0].GetLayer(0).GetEmitter(0);
				emitter.mEmitterInstanceDef.mPoints[1].mValuePoint2DVector[0].mValue = new Vector2(0f, -num19);
				num16 = (float)Common._S(this.GetCenterX() - Common._M(-26));
				num17 = (float)Common._S(this.GetCenterY() - Common._M(0));
				Common.RotatePoint(num15, ref num16, ref num17, (float)Common._S(this.GetCenterX()), (float)Common._S(this.GetCenterY()));
				this.mCP.mX = (int)num16;
				this.mCP.mY = (int)num17;
				array3[1] = CommonMath.AngleBetweenPoints(this.mCP, this.mGp);
				if (g.Is3D())
				{
					g.DrawImageRotatedF(this.mLazer, (float)Common._S(this.GetCenterX() - Common._M(-15)), (float)Common._S(this.GetCenterY()) - num20, (double)(array3[1] - 1.570795f), (float)Common._S(Common._M1(-15)), num20, rect);
				}
				else
				{
					g.DrawImageRotated(this.mLazer, Common._S(this.GetCenterX() - Common._M(-15)), (int)((float)Common._S(this.GetCenterY()) - num20), (double)(array3[1] - 1.570795f), Common._S(Common._M1(-15)), (int)num20, rect);
				}
				g.SetDrawMode(0);
				emitter = array2[1].GetLayer(0).GetEmitter(0);
				emitter.mEmitterInstanceDef.mPoints[1].mValuePoint2DVector[0].mValue = new Vector2(0f, -num19);
				g.SetColor(Color.White);
				g.FillRect(this.mGp.mX, this.mGp.mY, 4, 4);
				for (int num21 = 0; num21 <= 1; num21++)
				{
					emitter = array2[num21].GetLayer(0).GetEmitter(0);
					...
					{
						if (MathUtils.Distance(new Point(0, 0), new Point((int)piparticleInstance.mEmittedPos.X, (int)piparticleInstance.mEmittedPos.Y), true) > num19)
						{
							piparticleInstance.mLife = 0f;
						}
					}
					array2[num21].mDrawTransform.LoadIdentity();
					float num22 = GameApp.DownScaleNum(1f);
					array2[num21].mDrawTransform.Scale(num22, num22);
					array2[num21].mDrawTransform.Translate((float)Common._S((num21 == 0) ? -22 : 24), 0f);
					array2[num21].mDrawTransform.RotateRad(array3[num21] - 1.5705f);
					array2[num21].mDrawTransform.Translate((float)Common._S(this.GetCenterX()), (float)Common._S(this.GetCenterY()));
					array2[num21].Draw(g);
				}
				this.mBoard.mLazerBurn.mDrawTransform.LoadIdentity();
				this.mBoard.mLazerBurn.mDrawTransform.Scale(Common._DS(1.4f), Common._DS(1.4f));
			...
			else if (this.LightningMode() && !this.mBoard.IsPaused())
			{
				float num23;
				float num24;
				GameApp.gApp.GetBoard().GetGuideTargetCenter(out num23, out num24, true);
				g.SetColor(0, 0, 255);
				float num25 = this.GetAngle() - 3.14159f;
				float num26 = (float)Common._S(this.GetCenterX() + Common._M(0));
				float num27 = (float)Common._S(this.GetCenterY() + Common._M(-30));
				Common.RotatePoint(num25, ref num26, ref num27, (float)this.GetCenterX(), (float)this.GetCenterY());
			}
			...
			if (!this.mBoard.IsPaused() && this.mBoard.GetGameState() != GameState.GameState_Losing)
			{
				...
				if (this.mBoard.mLevel.mInvertMouseTimer > 0)
				{
					g.SetFont(fontByID);
					g.SetColor(Color.White);
					g.DrawString(TextManager.getInstance().getString(471), Common._S(this.GetCenterX() - Common._M(30)), Common._S(this.GetCenterY() - Common._M1(80)));
				}
				if (this.mSlowTimer > 0)
				{
					g.SetFont(fontByID);
					g.SetColor(Color.White);
					g.DrawString(TextManager.getInstance().getString(472), Common._S(this.GetCenterX() - Common._M(47)), Common._S(this.GetCenterY() - Common._M1(80)));
				}
			...
			if (this.mBoard.GetGameState() != GameState.GameState_Losing)
			{
				for (int num28 = 0; num28 < Common.size<Bubble>(this.mBubbles); num28++)
				{
					this.mBubbles[num28].Draw(g);
				}
			}
			for (int num29 = 0; num29 < Common.size<SkeletonPowerOrb>(this.mPowerOrbs); num29++)
			{
				SkeletonPowerOrb skeletonPowerOrb = this.mPowerOrbs[num29];
				g.SetColorizeImages(true);
				g.SetColor(255, 255, 255, (int)skeletonPowerOrb.mAlpha);
				Image imageByID4 = Res.GetImageByID(ResID.IMAGE_BOSS_SKELETON_GLOWBALL);
				int num30 = Common._M(-25);
				int num31 = Common._M(-20);
				float num32 = (float)imageByID4.GetCelWidth() * skeletonPowerOrb.mSize;
				float num33 = (float)imageByID4.GetCelHeight() * skeletonPowerOrb.mSize;
				g.DrawImage(imageByID4, (int)(Common._S(this.mCurX + (float)num30) + (float)(imageByID4.GetCelWidth() / 2) - num32 / 2f), (int)(Common._S(this.mCurY + (float)num31) + (float)(imageByID4.GetCelHeight() / 2) - num33 / 2f), (int)num32, (int)num33);
				g.SetDrawMode(1);
				g.DrawImage(imageByID4, (int)(Common._S(this.mCurX + (float)num30) + (float)(imageByID4.GetCelWidth() / 2) - num32 / 2f), (int)(Common._S(this.mCurY + (float)num31) + (float)(imageByID4.GetCelHeight() / 2) - num33 / 2f), (int)num32, (int)num33);
				g.SetColorizeImages(false);
				g.SetDrawMode(0);
			}
			for (int num34 = 0; num34 < Common.size<OrbPowerRing>(this.mPowerRings); num34++)
			{
				this.mPowerRings[num34].Draw(g, (float)((int)Common._S(this.mCurX)), (float)((int)Common._S(this.mCurY)));
			}
		...
		// Token: 0x06000AE2 RID: 2786 RVA: 0x000642EF File Offset: 0x000624EF
		public void Draw(SexyGraphics g)
		{
			this.Draw(g, 0);
		}

		// Token: 0x06000AE3 RID: 2787 RVA: 0x000642FC File Offset: 0x000624FC
		public void DrawCannonPaths(SexyGraphics g, float inAngle, int inX, int inY)
		{
		...
		// Token: 0x06000AE4 RID: 2788 RVA: 0x00064398 File Offset: 0x00062598
		...
		// Token: 0x06000AE5 RID: 2789 RVA: 0x00064418 File Offset: 0x00062618
		public void DrawBulletPath(Graphics3D g3D, float inAngle, float inX, float inY)
		{
			...
			float num3 = (float)Common._DS(Common._M(1300));
			float num4 = Common._M(0.95f);
			Gun.aChevronSpeed += Common._M(0.006f);
			SexyVertex2D sexyVertex2D;
			sexyVertex2D = new SexyVertex2D(inX, inY, 0f, num2 + Gun.aChevronSpeed);
			SexyVertex2D sexyVertex2D2;
			sexyVertex2D2 = new SexyVertex2D(inX + num3 * (float)Math.Cos((double)inAngle), inY - num3 * (float)Math.Sin((double)inAngle), 1f, Gun.aChevronSpeed);
			SexyVertex2D sexyVertex2D3;
			sexyVertex2D3 = new SexyVertex2D(inX + num3 * num4 * (float)Math.Cos((double)(inAngle + num)), inY - num3 * num4 * (float)Math.Sin((double)(inAngle + num)), 0f, Gun.aChevronSpeed);
			SexyVertex2D sexyVertex2D4;
			sexyVertex2D4 = new SexyVertex2D(inX + num3 * num4 * (float)Math.Cos((double)(inAngle - num)), inY - num3 * num4 * (float)Math.Sin((double)(inAngle - num)), 0f, Gun.aChevronSpeed);
			...
			g3D.DrawPrimitiveEx((uint)SexyVertex2D.FVF, (Graphics3D.EPrimitiveType)4, array, 2, new Color(255, 255, 255, Common._M(160)), 0, 0f, 0f, true, 0U);
		}

		// Token: 0x06000AE6 RID: 2790 RVA: 0x000645B0 File Offset: 0x000627B0
		...
		// Token: 0x06000AE7 RID: 2791 RVA: 0x00064810 File Offset: 0x00062A10
		...
		// Token: 0x06000AE8 RID: 2792 RVA: 0x000648B0 File Offset: 0x00062AB0
		...
		// Token: 0x06000AE9 RID: 2793 RVA: 0x00064950 File Offset: 0x00062B50
		...
		// Token: 0x06000AEA RID: 2794 RVA: 0x000649F0 File Offset: 0x00062BF0
		...
		// Token: 0x06000AEB RID: 2795 RVA: 0x00064A90 File Offset: 0x00062C90
		public void SyncState(DataSync theSync)
		{
			...
			if (theSync.isRead())
			{
				...
				if (buffer.ReadBoolean())
				{
					...
					transform.Translate((float)Common._S(this.GetCenterX() + Common._DS(Common._M(-70))), (float)Common._S(this.GetCenterY() + Common._DS(Common._M1(-55))));
				...
				if (buffer.ReadBoolean())
				{
					...
					transform2.Translate((float)Common._S(this.GetCenterX() + Common._M(-52)), (float)Common._S(this.GetCenterY() + Common._M1(-13)));
			...
			if (theSync.isWrite())
			{
				...
				for (int i = 0; i < Common.size<FrogBody>(this.mFrogStack); i++)
				{
				...
				{
					Common.SerializeParticleSystem(this.mDizzyStars, theSync);
				}
			}
			else
			{
				...
				for (int j = 0; j < num7; j++)
				{
					...
					Common.back<FrogBody>(this.mFrogStack).SyncState(theSync);
				}
				this.mDizzyStars = null;
				if (buffer.ReadBoolean())
				{
					this.mDizzyStars = Common.DeserializeParticleSystem(theSync);
				}
			}
			if (theSync.isRead())
			{
			...
			for (int m = 0; m < 3; m++)
			{
				...
				if (theSync.isRead())
				{
					...
					for (int n = 0; n < Common.size<BeamComponent>(this.mBeams[m]); n++)
					{
		...
		// Token: 0x06000AEC RID: 2796 RVA: 0x00065390 File Offset: 0x00063590
		...
		// Token: 0x06000AED RID: 2797 RVA: 0x00065444 File Offset: 0x00063644
		...
		// Token: 0x06000AEE RID: 2798 RVA: 0x000654A0 File Offset: 0x000636A0
		public Bullet GetFiredBullet()
		{
			if (this.mState != GunState.GunState_Firing || this.mStatePercent < Common._M(0.9f))
			{
				return null;
			}
			...
			Bullet bullet = this.mBullet;
			if (Common.size<Bullet>(this.mCannonBullets) > 0)
			{
		...
		// Token: 0x06000AEF RID: 2799 RVA: 0x00065578 File Offset: 0x00063778
		public void SetPos(int theX, int theY)
		{
			...
			this.CalcAngle();
			int num = (this.GetCenterX() > Common._SS(GameApp.gApp.mWidth) - this.GetCenterX()) ? 0 : Common._SS(GameApp.gApp.mWidth);
			int num2 = (this.GetCenterY() > Common._SS(GameApp.gApp.mHeight) - this.GetCenterY()) ? 0 : Common._SS(GameApp.gApp.mHeight);
			this.mFarthestDistance = MathUtils.Distance((float)this.GetCenterX(), (float)this.GetCenterY(), (float)num, (float)num2);
		}

		// Token: 0x06000AF0 RID: 2800 RVA: 0x00065634 File Offset: 0x00063834
		public void Update()
		{
			if (this.mBossStateAlphaDir != 0)
			{
				this.mBossStateAlpha += Common._M(1.5f) * (float)this.mBossStateAlphaDir;
				if (this.mBossStateAlpha > 255f)
				{
					this.mBossStateAlphaDir = 0;
			...
			{
				this.mGlobalTranform.Reset();
				this.mGlobalTranform.Translate(Common._S(this.mCenterX + (float)Common._M(-45)), 0f);
			...
			for (int i = 0; i < 4; i++)
			{
				if (this.mLazerFrogBackPulseAlpha[i] > 0f)
				{
					...
					this.mLazerFrogBackPulseAlpha[i] -= Common._M(10f);
					if (this.mLazerFrogBackPulseAlpha[i] < 0f)
					{
						this.mLazerFrogBackPulseAlpha[i] = 0f;
					}
					if (num3 > (float)Common._M(200) && this.mLazerFrogBackPulseAlpha[i] < (float)Common._M1(200) && i + 1 < 4 && this.mLazerFrogBackPulseAlpha[i + 1] == 0f)
					{
						this.mLazerFrogBackPulseAlpha[i + 1] = 255f;
					}
					if (this.mLazerFrogBackPulseAlpha[i] > (float)Common._M(200))
					{
						break;
					}
				}
			...
			if (this.mDoingCannonBlast && this.mCannonBlast.IsActive())
			{
				...
				else
				{
					...
					float num5 = (float)Common._DS(Common._M(0));
					float num6 = (float)Common._DS(Common._M(185));
					Common.RotatePoint(this.mAngle, ref num5, ref num6, 0f, 0f);
					this.mCannonBlast.mDrawTransform.Translate(Common._S(this.mCurX) + num5, Common._S(this.mCurY) + num6);
				}
			}
			if (this.mDizzyStars != null)
			{
			...
			{
				this.mGlobalTranform.Reset();
				float num7 = Common._DS(1f);
				int num8 = (int)(Common._M(400f) * num7);
				int num9 = (int)(Common._M(330f) * num7);
				...
				this.mGlobalTranform.Translate((float)Common._S(this.GetCenterX() + Common._M(-100)), (float)Common._S(this.GetCenterY() + Common._M(-80)));
			...
			else if (this.mDarkFrogStun != null)
			{
				...
				transform = new SexyTransform2D(false);
				float num10 = Common._DS(1f);
				int num11 = (int)((float)Common._M(400) * num10);
				int num12 = (int)((float)Common._M(330) * num10);
				...
				transform.Translate((float)Common._S(this.GetCenterX() + Common._M(-52)), (float)Common._S(this.GetCenterY() + Common._M1(-13)));
			...
			if (this.mBoard.GetHallucinateTimer() > 0)
			{
				...
				this.mTempText.SetX((float)Common._S(this.GetCenterX() - Common._M(32)));
				this.mTempText.SetY((float)Common._S(this.GetCenterY() - Common._M(100)));
			}
			...
			for (int l = 0; l < Enumerable.Count<SkeletonPowerOrb>(this.mPowerOrbs); l++)
			{
				...
				float num13 = Common._M(2f);
				float num14 = Common._M(0.1f);
			...
			if (this.IsFuckedUp() && !this.IsStunned() && this.mUpdateCount % Common._M(10) == 0)
			{
				...
				confusionMark.mVX = (Common._M(0.1f) + (float)(Common.Rand() % Common._M1(1000)) / Common._M2(1000f)) * (float)((Common.Rand() % 100 < 50) ? 1 : -1);
				confusionMark.mVY = (Common._M(0.1f) + (float)(Common.Rand() % Common._M1(1000)) / Common._M2(1000f)) * (float)((Common.Rand() % 100 < 50) ? 1 : -1);
			}
			if (this.mBlinkCount >= 0 && --this.mBlinkTimer == 0)
			{
				this.mBlinkCount--;
				this.mBlinkTimer = (int)Common._M(15f);
			}
			if (this.mSpitAlpha > 0f)
			{
				this.mSpitAlpha -= Common._M(6f);
			...
			if (this.mStunTimer > 0 && this.mFlameStun == null && this.mDarkFrogStun == null && this.mBlinkCount < 0)
			{
				...
				{
					if (this.mStunTimer >= this.mStartingStunTime - Common._M(50) && this.mStunSpinFrame == 2)
					{
					...
					else if (this.mStunTimer - 3 * num15 <= 0 && this.mStunSpinFrame < imageByID.mNumRows - 1)
					{
						...
						if (this.mStunSpinFrame == 1)
						{
							...
							this.mSpitAngle = MathUtils.DegreesToRadians((float)Common._M(-60));
							this.mSpitVX = (float)Common._M(1) * (float)Math.Cos((double)this.mSpitAngle);
							this.mSpitVY = (float)(-(float)Common._M(1)) * (float)Math.Sin((double)this.mSpitAngle);
							this.mSpitX = this.mCenterX + (float)Common._M(50);
							this.mSpitY = this.mCenterY + (float)Common._M(30);
						}
					}
				}
				if (--this.mStunTimer == 0)
				{
					...
					{
						this.mConfusionMarks[n].mAlphaInc = Common._M(-4f);
					}
					this.mBlinkCount = 3;
				}
			}
			...
			float num17 = Common._M(1f);
			if (this.mLazerCount > 0 && this.mLazerPercent < num17)
			{
				this.mLazerPercent += Common._M(0.07f);
			...
			{
				this.mLazerPercent -= Common._M(0.06f);
			...
			if (this.mDestCount > 0)
			{
				...
				if (this.mBoard.mLevel.mZone == 5 && this.mBoard.mLevel.mNum != 10 && this.mBoard.mLevel.mMoveType == 0)
				{
					...
					else if (this.mUpdateCount % Common._M(10) == 0)
					{
						this.DoBubbles(1);
					}
				}
			...
			float num22 = (this.mSlowTimer > 0) ? Common._M(4f) : 1f;
			int num23 = 1;
			...
			if (this.mState == GunState.GunState_Firing)
			{
				...
				{
					this.mBullet.Update();
					this.mRecoilAmt += Common._M(2.33f);
				}
			}
			else
			{
				this.mStatePercent += 0.07f / num22 * (float)num23;
				if (this.mState == GunState.GunState_Reloading && (this.mRecoilAmt -= Common._M(0.7f) / num22) < 0f)
				{
					this.mRecoilAmt = 0f;
				}
			}
			...
			if (this.mState == GunState.GunState_Normal && this.mRecoilAmt > 0f && (this.mRecoilAmt -= Common._M(0.7f) / num22) < 0f)
			{
				this.mRecoilAmt = 0f;
			}
			if (this.CannonMode() || (this.mBullet != null && this.mBullet.GetIsCannon()))
			{
				if (this.mUpdateCount % Common._M(18) == 0)
				{
		...
		// Token: 0x06000AF1 RID: 2801 RVA: 0x00066A0C File Offset: 0x00064C0C
		...
		// Token: 0x06000AF2 RID: 2802 RVA: 0x00066AA5 File Offset: 0x00064CA5
		public void SwapBullets()
		{
			this.SwapBullets(true);
		}

		// Token: 0x06000AF3 RID: 2803 RVA: 0x00066AAE File Offset: 0x00064CAE
		...
		// Token: 0x06000AF4 RID: 2804 RVA: 0x00066ADB File Offset: 0x00064CDB
		public void EmptyBullets()
		{
			this.EmptyBullets(true);
		}

		// Token: 0x06000AF5 RID: 2805 RVA: 0x00066AE4 File Offset: 0x00064CE4
		...
		// Token: 0x06000AF6 RID: 2806 RVA: 0x00066AFE File Offset: 0x00064CFE
		...
		// Token: 0x06000AF7 RID: 2807 RVA: 0x00066B18 File Offset: 0x00064D18
		public Rect GetRect()
		{
		...
		// Token: 0x06000AF8 RID: 2808 RVA: 0x00066B54 File Offset: 0x00064D54
		...
		// Token: 0x06000AF9 RID: 2809 RVA: 0x00066D70 File Offset: 0x00064F70
		public void SetCannonCount(int c, bool stack, int color_type)
		{
			this.SetCannonCount(c, stack, color_type, -100f);
		}

		// Token: 0x06000AFA RID: 2810 RVA: 0x00066D80 File Offset: 0x00064F80
		...
		// Token: 0x06000AFB RID: 2811 RVA: 0x00066D96 File Offset: 0x00064F96
		public void DoLightningFrog()
		{
			this.DoLightningFrog(true);
		}

		// Token: 0x06000AFC RID: 2812 RVA: 0x00066D9F File Offset: 0x00064F9F
		...
		// Token: 0x06000AFD RID: 2813 RVA: 0x00066DD0 File Offset: 0x00064FD0
		...
		// Token: 0x06000AFE RID: 2814 RVA: 0x00066E1A File Offset: 0x0006501A
		public void ResetFrogType()
		{
			this.SetFrogType(FrogType.FrogType_Normal, false);
		}

		// Token: 0x06000AFF RID: 2815 RVA: 0x00066E24 File Offset: 0x00065024
		...
		// Token: 0x06000B00 RID: 2816 RVA: 0x00066E44 File Offset: 0x00065044
		...
		// Token: 0x06000B01 RID: 2817 RVA: 0x00066E98 File Offset: 0x00065098
		public int GetCenterX()
		{
			return (int)this.mCenterX;
		}

		// Token: 0x06000B02 RID: 2818 RVA: 0x00066EA1 File Offset: 0x000650A1
		public int GetCenterY()
		{
			return (int)this.mCenterY;
		}

		// Token: 0x06000B03 RID: 2819 RVA: 0x00066EAA File Offset: 0x000650AA
		public int GetCurX()
		{
			return (int)this.mCurX;
		}

		// Token: 0x06000B04 RID: 2820 RVA: 0x00066EB3 File Offset: 0x000650B3
		public int GetCurY()
		{
			return (int)this.mCurY;
		}

		// Token: 0x06000B05 RID: 2821 RVA: 0x00066EBC File Offset: 0x000650BC
		public int GetCenterXDest()
		{
			return (int)((this.mDestCount != 0) ? ((float)this.mDestX2) : this.mCenterX);
		}

		// Token: 0x06000B06 RID: 2822 RVA: 0x00066ED6 File Offset: 0x000650D6
		public int GetCenterYDest()
		{
			return (int)((this.mDestCount != 0) ? ((float)this.mDestY2) : this.mCenterY);
		}

		// Token: 0x06000B07 RID: 2823 RVA: 0x00066EF0 File Offset: 0x000650F0
		public int GetWidth()
		{
			return this.mWidth;
		}

		// Token: 0x06000B08 RID: 2824 RVA: 0x00066EF8 File Offset: 0x000650F8
		public int GetHeight()
		{
			return this.mHeight;
		}

		// Token: 0x06000B09 RID: 2825 RVA: 0x00066F00 File Offset: 0x00065100
		public int GetType()
		{
		...
		// Token: 0x06000B0A RID: 2826 RVA: 0x00066F39 File Offset: 0x00065139
		public int GetLazerCount()
		{
			return this.mLazerCount;
		}

		// Token: 0x06000B0B RID: 2827 RVA: 0x00066F41 File Offset: 0x00065141
		public Bullet GetBullet()
		{
			return this.mBullet;
		}

		// Token: 0x06000B0C RID: 2828 RVA: 0x00066F49 File Offset: 0x00065149
		public Bullet GetNextBullet()
		{
			return this.mNextBullet;
		}

		// Token: 0x06000B0D RID: 2829 RVA: 0x00066F51 File Offset: 0x00065151
		public float GetAngle()
		{
			return this.mAngle;
		}

		// Token: 0x06000B0E RID: 2830 RVA: 0x00066F59 File Offset: 0x00065159
		public float GetDestAngle()
		{
			return this.mDestAngle;
		}

		// Token: 0x06000B0F RID: 2831 RVA: 0x00066F61 File Offset: 0x00065161
		public bool IsInked()
		{
			return this.mBossStateAlpha > 0f;
		}

		// Token: 0x06000B10 RID: 2832 RVA: 0x00066F70 File Offset: 0x00065170
		public bool IsFiring()
		{
			return this.mState == GunState.GunState_Firing;
		}

		// Token: 0x06000B11 RID: 2833 RVA: 0x00066F7B File Offset: 0x0006517B
		public bool IsHopping()
		{
			return this.mDoingHop && this.mDestCount > 0;
		}

		// Token: 0x06000B12 RID: 2834 RVA: 0x00066F90 File Offset: 0x00065190
		public bool IsMovingToDest()
		{
			return this.mDestCount > 0;
		}

		// Token: 0x06000B13 RID: 2835 RVA: 0x00066F9B File Offset: 0x0006519B
		public bool CannonMode()
		{
			return this.mCannonCount > 0;
		}

		// Token: 0x06000B14 RID: 2836 RVA: 0x00066FA6 File Offset: 0x000651A6
		public bool LaserMode()
		{
			return this.GetType() == 2 && this.mLazerPercent > 0f;
		}

		// Token: 0x06000B15 RID: 2837 RVA: 0x00066FC0 File Offset: 0x000651C0
		public bool LightningMode()
		{
			return this.GetType() == 3;
		}

		// Token: 0x06000B16 RID: 2838 RVA: 0x00066FCB File Offset: 0x000651CB
		public bool IsCannon()
		{
			return this.GetType() == 1;
		}

		// Token: 0x06000B17 RID: 2839 RVA: 0x00066FD6 File Offset: 0x000651D6
		public bool IsStunned()
		{
			return this.mStunTimer > 0;
		}

		// Token: 0x06000B18 RID: 2840 RVA: 0x00066FE1 File Offset: 0x000651E1
		public bool IsPoisoned()
		{
			return this.mBoard.mLevel.mInvertMouseTimer > 0;
		}

		// Token: 0x06000B19 RID: 2841 RVA: 0x00066FF6 File Offset: 0x000651F6
		public bool HasSmokeParticles()
		{
			return Enumerable.Count<LTSmokeParticle>(this.mSmokeParticles) > 0;
		}

		// Token: 0x06000B1A RID: 2842 RVA: 0x00067006 File Offset: 0x00065206
		public bool IsSlow()
		{
			return this.mSlowTimer > 0;
		}

		// Token: 0x06000B1B RID: 2843 RVA: 0x00067014 File Offset: 0x00065214
		...
		// Token: 0x06000B1C RID: 2844 RVA: 0x00067061 File Offset: 0x00065261
		...
		// Token: 0x06000B1D RID: 2845 RVA: 0x00067090 File Offset: 0x00065290
		public bool StunnedFromBoss6()
		{
			return this.mFlameStun != null || this.mDarkFrogStun != null;
		}

		// Token: 0x06000B1E RID: 2846 RVA: 0x000670A8 File Offset: 0x000652A8
		public void ToggleShowNextBall()
		{
			this.mShowNextBall = !this.mShowNextBall;
		}

		// Token: 0x06000B1F RID: 2847 RVA: 0x000670BC File Offset: 0x000652BC
		...
		// Token: 0x06000B20 RID: 2848 RVA: 0x000670FD File Offset: 0x000652FD
		public void SetFireSpeed(float theSpeed)
		{
			this.mFireVel = theSpeed;
		}

		// Token: 0x06000B21 RID: 2849 RVA: 0x00067108 File Offset: 0x00065308
		public void Stun(int timer)
		{
			...
			if (this.mBoard.mLevel.mEndSequence == 5)
			{
				...
				this.mGlobalTranform.Translate((float)Common._S(this.GetCenterX() + Common._M(-52)), (float)Common._S(this.GetCenterY() + Common._M1(-13)));
			...
			if (this.mBoard.mLevel.mEndSequence != 3 && this.mDizzyStars == null)
			{
				...
				this.mDizzyStars.mScale = Common._S(1f);
				...
				{
					mLifeScale = Common._M(0.5f),
					mNumberScale = Common._M(1.61f),
					mSizeXScale = Common._M(1.4f),
					mWeightScale = 0f,
					mSpinScale = Common._M(0.2f),
					mMotionRandScale = 0f,
					mZoom = Common._M(0.14f)
				});
				...
				emitterSettings = new EmitterSettings(emitterSettings);
				emitterSettings.mVisibility = 0f;
				emitter.AddSettingsKeyFrame(this.mStunTimer + Common._M(150), emitterSettings);
				...
				particleType.mColorKeyManager.AddColorKey(0f, new Color(59, 228, 93));
				...
				particleSettings.mWeight = (float)Common._M(101);
				particleSettings.mSpin = Common.DegreesToRadians((float)Common._M(40));
				particleType.AddSettingsKeyFrame(0, particleSettings);
				particleSettings = new ParticleSettings(particleSettings);
				particleType.AddSettingsKeyFrame(this.mStunTimer + Common._M(100), particleSettings);
				particleSettings = new ParticleSettings(particleSettings);
				particleSettings.mLife = 0;
				particleType.AddSettingsKeyFrame(this.mStunTimer + Common._M(150), particleSettings);
				particleType.AddVarianceKeyFrame(0, new ParticleVariance
				{
					mLifeVar = Common._M(54),
					mSizeXVar = Common._M(9),
					mWeightVar = Common._M(37),
					mSpinVar = Common.DegreesToRadians((float)Common._M(80))
				});
			...
			if (this.mBoard.mLevel.mEndSequence == 3)
			{
				...
				this.mGlobalTranform.Translate((float)Common._S(this.GetCenterX() + Common._DS(Common._M(-70))), (float)Common._S(this.GetCenterY() + Common._DS(Common._M1(-55))));
				this.mFlameStun.SetTransform(this.mGlobalTranform.GetMatrix());
				this.mFlameStun.Play("Main");
			}
		}

		// Token: 0x06000B22 RID: 2850 RVA: 0x00067894 File Offset: 0x00065A94
		...
		// Token: 0x06000B23 RID: 2851 RVA: 0x000678F8 File Offset: 0x00065AF8
		...
		// Token: 0x06000B24 RID: 2852 RVA: 0x0006791D File Offset: 0x00065B1D
		public void AddPowerRing(OrbPowerRing p)
		{
			this.mPowerRings.Add(p);
		}

		// Token: 0x06000B25 RID: 2853 RVA: 0x0006792B File Offset: 0x00065B2B
		public void AddPowerOrb(SkeletonPowerOrb o)
		{
			this.mPowerOrbs.Add(o);
		}

		// Token: 0x06000B26 RID: 2854 RVA: 0x0006793C File Offset: 0x00065B3C
		public void ForceX(int x)
		{
			this.mCenterX = (this.mCurX = (float)x);
		}

		// Token: 0x06000B27 RID: 2855 RVA: 0x0006795C File Offset: 0x00065B5C
		public void ForceY(int y)
		{
			this.mCenterY = (this.mCurY = (float)y);
		}

		// Token: 0x06000B28 RID: 2856 RVA: 0x0006797C File Offset: 0x00065B7C
		...
		// Token: 0x06000B29 RID: 2857 RVA: 0x000679E8 File Offset: 0x00065BE8
		public void UpdateShotCorrectionTarget()
		{
			...
			sexyVector = new SexyVector3((float)this.mBoard.mFrog.GetCurX(), (float)this.mBoard.mFrog.GetCurY(), 0f);
			...
			bool flag = true;
			flag = (flag && Common.size<Bullet>(this.mBoard.mBulletList) == 0);
			...
			if (flag && (this.mBoard.mGuideBall == null || this.mBoard.mGuideBall.GetColorType() != this.mBullet.GetColorType()))
			{
					...
					foreach (Ball ball in this.mBoard.mLevel.mCurveMgr[i].mBallList)
					{
						if (!ball.GetInTunnel() && !ball.GetIsExploding())
						{
							if (ball.GetColorType() == this.mBullet.GetColorType())
							{
								...
								SexyVector3 vDir;
								vDir = new SexyVector3(vShiftedPos.x - sexyVector.x, vShiftedPos.y - sexyVector.y, 0f);
								if (this.IsTargetWithinShotCorrectionRange(vShiftedPos, num))
								{
									if ((flag2 && (ball.GetNextBall() == null || !ball.CollidesWithPhysically(ball.GetNextBall(), 1))) || (!flag2 && (ball.GetPrevBall() == null || !ball.CollidesWithPhysically(ball.GetPrevBall(), 1))))
									{
										...
										SexyVector3 vDir2;
										vDir2 = new SexyVector3(sexyVector2.x - sexyVector.x, sexyVector2.y - sexyVector.y, 0f);
							...
							else
							{
								...
								if (flag3)
								{
									...
									SexyVector3 vDir3;
									vDir3 = new SexyVector3(vShiftedPos2.x - sexyVector.x, vShiftedPos2.y - sexyVector.y, 0f);
				...
				float num4 = 4.14159f;
				for (int j = 0; j < Common.size<Gun.BallShotInfo>(list); j++)
				{
					...
					if (Math.Abs(num5) < num4)
					{
						...
						SexyVector3 vDir4;
						vDir4 = new SexyVector3(sexyVector3.x - sexyVector.x, sexyVector3.y - sexyVector.y, 0f);
		...
		// Token: 0x06000B2A RID: 2858 RVA: 0x0006803C File Offset: 0x0006623C
		public void UpdateAutoMonkeyShotCorrection()
		{
			...
			if (this.mBoard.mCurTreasure != null && !this.mBoard.mTreasureWasHit)
			{
				...
				sexyVector2 = new SexyVector3((float)this.mBoard.mCurTreasure.x - sexyVector.x, (float)this.mBoard.mCurTreasure.y - sexyVector.y, 0f);
			...
			Ball ball = null;
			Ball ball2 = null;
			SexyVector2 sexyVector4;
			sexyVector4 = new SexyVector2(0f, 0f);
			SexyVector2 sexyVector5;
			...
			while (num5 < this.mBoard.mLevel.mNumCurves && flag)
			{
				foreach (Ball ball3 in this.mBoard.mLevel.mCurveMgr[num5].mBallList)
				{
					if (ball3 != null && this.mBullet != null && !ball3.GetIsExploding() && ball3.GetColorType() == this.mBullet.GetColorType())
					{
						...
						if (!flag2)
						{
							SexyVector2 sexyVector6 = ball3.GetPos() + this.ShiftTargetTowardFrog(ball3);
							SexyVector3 vDir;
							vDir = new SexyVector3(sexyVector6.x - sexyVector.x, sexyVector6.y - sexyVector.y, 0f);
							Ball ball4 = this.CheckPotentialShot(vDir);
							if (ball3 == ball4 && ball2 == null && !ball3.GetInTunnel())
							{
								bool flag3 = false;
								sexyVector5 = ball3.GetPos() + this.ShiftTargetByEverything(ball3, ref flag3);
								ball2 = ball3;
							}
						}
					}
			...
			if (ball != null)
			{
				this.mShotCorrectionTarget = sexyVector4;
			}
		...
		// Token: 0x06000B2B RID: 2859 RVA: 0x00068584 File Offset: 0x00066784
		public void CheckMonkeyShot(float x, float y, ref bool bDoNormalShot)
		{
			SexyVector3 sexyVector;
			sexyVector = new SexyVector3((float)this.mBoard.mFrog.GetCurX(), (float)this.mBoard.mFrog.GetCurY(), 0f);
			SexyVector2 sexyVector2;
			sexyVector2 = new SexyVector2(x - sexyVector.x, y - sexyVector.y);
			Ball ball = this.CheckPotentialShot(new SexyVector3(sexyVector2.x, sexyVector2.y, 0f));
			SexyVector3 sexyVector3;
			sexyVector3 = new SexyVector3(0f, 0f, 0f);
			if (ball != null)
			{
				sexyVector3 = new SexyVector3(ball.GetX() - sexyVector.x, ball.GetY() - sexyVector.y, 0f);
			}
			if (ball == null || sexyVector2.MagnitudeSquared() < sexyVector3.Magnitude() * sexyVector3.Magnitude())
			{
		...
		// Token: 0x06000B2C RID: 2860 RVA: 0x0006865C File Offset: 0x0006685C
		public Ball CheckPotentialShot(SexyVector3 vDir, bool bWidthCheck)
		{
			...
			SexyVector3 sexyVector3;
			sexyVector3 = new SexyVector3(sexyVector2.y, sexyVector2.x, sexyVector2.z);
			Ball ball = null;
			float num = 1000000f;
			float num2 = num;
			float num3 = num;
			for (int i = 0; i < this.mBoard.mLevel.mNumCurves; i++)
			{
				...
				if (ball2 != null)
				{
					...
					if (bWidthCheck)
					{
						Ball ball3 = this.mBoard.mLevel.mCurveMgr[i].CheckBallIntersection(sexyVector - sexyVector3 * ((float)ball2.GetRadius() + 1f), sexyVector2, ref num2, true);
						Ball ball4 = this.mBoard.mLevel.mCurveMgr[i].CheckBallIntersection(sexyVector + sexyVector3 * ((float)ball2.GetRadius() + 1f), sexyVector2, ref num3, true);
			...
			{
				SexyVector3 sexyVector4 = sexyVector + sexyVector2 * num4;
				...
				if (bWidthCheck)
				{
					SexyVector3 sexyVector5 = sexyVector - sexyVector3 * (float)ball.GetRadius() + sexyVector2 * num4;
					if (this.mBoard.mLevel.PointIntersectsWall(sexyVector5.x, sexyVector5.y))
					{
						ball = null;
					}
					SexyVector3 sexyVector6 = sexyVector + sexyVector3 * (float)ball.GetRadius() + sexyVector2 * num4;
					if (this.mBoard.mLevel.PointIntersectsWall(sexyVector6.x, sexyVector6.y))
					{
						ball = null;
					}
				}
		...
		// Token: 0x06000B2D RID: 2861 RVA: 0x000688BF File Offset: 0x00066ABF
		public Ball CheckPotentialShot(SexyVector3 vDir)
		{
			return this.CheckPotentialShot(vDir, false);
		}

		// Token: 0x06000B2E RID: 2862 RVA: 0x000688CC File Offset: 0x00066ACC
		public bool IsTargetWithinShotCorrectionRange(SexyVector2 vShiftedPos, float targetRad)
		{
			SexyVector2 sexyVector;
			sexyVector = new SexyVector2((float)this.mBoard.mFrog.GetCurX(), (float)this.mBoard.mFrog.GetCurY());
			SexyVector2 sexyVector2;
			sexyVector2 = new SexyVector2(this.mBoard.mGuideBallPoint.x, this.mBoard.mGuideBallPoint.y);
			bool flag = (sexyVector - sexyVector2).Magnitude() < this.mBoard.mApp.mShotCorrectionAngleToWidthDist;
			if (flag)
			{
				float num = (float)Math.Atan2((double)(sexyVector.y - vShiftedPos.y), (double)(vShiftedPos.x - sexyVector.x));
				num -= targetRad;
				if (num < -3.14159f)
				{
					num += 6.28318f;
		...
		// Token: 0x06000B2F RID: 2863 RVA: 0x000689F0 File Offset: 0x00066BF0
		public SexyVector2 ShiftTargetTowardFrog(Ball aBall)
		{
			...
			SexyVector2 sexyVector5;
			sexyVector5 = new SexyVector2(-sexyVector4.y, sexyVector4.x);
			sexyVector2 = sexyVector5 * (float)aBall.GetRadius();
			sexyVector3 = -sexyVector5 * (float)aBall.GetRadius();
		...
		// Token: 0x06000B30 RID: 2864 RVA: 0x00068B1C File Offset: 0x00066D1C
		public SexyVector2 ShiftTargetTowardGuide(Ball aBall, ref bool bShiftedInTrackDir)
		{
			...
			sexyVector4 = sexyVector2 - sexyVector3;
			sexyVector4.Normalize();
			sexyVector2 = sexyVector4 * (float)aBall.GetRadius();
			sexyVector3 = -sexyVector4 * (float)aBall.GetRadius();
			SexyVector2 sexyVector5;
			sexyVector5 = new SexyVector2(this.mBoard.mGuideBallPoint.x, this.mBoard.mGuideBallPoint.y);
			...
			float num = (aBall.GetPos() + sexyVector2 - sexyVector).Normalize().Dot((sexyVector5 - sexyVector).Normalize());
			float num2 = (aBall.GetPos() + sexyVector3 - sexyVector).Normalize().Dot((sexyVector5 - sexyVector).Normalize());
		...
		// Token: 0x06000B31 RID: 2865 RVA: 0x00068CEC File Offset: 0x00066EEC
		public SexyVector2 ShiftTargetTowardBall(Ball aBall, bool bForward)
		{
			...
			if (bForward)
			{
				return sexyVector3 * (float)aBall.GetRadius();
			}
			return -sexyVector3 * (float)aBall.GetRadius();
		}

		// Token: 0x06000B32 RID: 2866 RVA: 0x00068D9C File Offset: 0x00066F9C
		public SexyVector2 ShiftTargetByBallSpeed(Ball aBall)
		{
			...
			if (aBall.GetWayPointProgress() != 0f)
			{
				...
				SexyVector2 sexyVector2;
				sexyVector2 = new SexyVector2(0f, 0f);
		...
		// Token: 0x06000B33 RID: 2867 RVA: 0x00068EA2 File Offset: 0x000670A2
		...
		{
			// Token: 0x06000DA6 RID: 3494 RVA: 0x0008B823 File Offset: 0x00089A23
