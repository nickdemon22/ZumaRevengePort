...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000E85 RID: 3717 RVA: 0x00095C2C File Offset: 0x00093E2C
		protected override void DrawBossSpecificArt(SexyGraphics g)
		{
			...
			if (this.mDeathState <= 1 && this.mDeathState >= 0)
			{
				...
				composition.Draw(g, cumulativeTransform, num3, Common._DS(1f));
			}
			...
			int num4 = this.mIsFiring ? Common._M(10) : 0;
			if (this.mDeathState == -1 || flag)
			{
				g.DrawImageRotated(Res.GetImageByID(ResID.IMAGE_BOSS_LAME_CHICKEN_LEFT), Common._S(num + Common._M(-20)), Common._S(num2 + Common._M1(68) + num4), (double)this.mAngleOff);
				g.DrawImageRotated(Res.GetImageByID(ResID.IMAGE_BOSS_LAME_CHICKEN_RIGHT), Common._S(num + Common._M(100)), Common._S(num2 + Common._M1(67) + num4), (double)(-(double)this.mAngleOff));
			}
			...
			for (int k = 0; k < this.mFeathers.Count; k++)
			{
				...
				float num5 = Math.Min(feather.mAlpha, this.mAlphaOverride);
				if (num5 != 255f)
				{
					g.SetColorizeImages(true);
					g.SetColor(255, 255, 255, (int)num5);
				}
		...
		// Token: 0x06000E86 RID: 3718 RVA: 0x000960FC File Offset: 0x000942FC
		...
		// Token: 0x06000E87 RID: 3719 RVA: 0x000961B2 File Offset: 0x000943B2
		...
		// Token: 0x06000E88 RID: 3720 RVA: 0x000961C1 File Offset: 0x000943C1
		protected override bool CanFire()
		{
			return Common._eq(this.mHP, this.mMaxHP);
		}

		// Token: 0x06000E89 RID: 3721 RVA: 0x000961D4 File Offset: 0x000943D4
		protected override bool CanRetaliate()
		{
			return false;
		}

		// Token: 0x06000E8A RID: 3722 RVA: 0x000961D8 File Offset: 0x000943D8
		...
		// Token: 0x06000E8B RID: 3723 RVA: 0x00096384 File Offset: 0x00094584
		...
		// Token: 0x06000E8C RID: 3724 RVA: 0x000963A5 File Offset: 0x000945A5
		...
		// Token: 0x06000E8D RID: 3725 RVA: 0x000963B8 File Offset: 0x000945B8
		protected override void BulletHitPlayer(BossBullet b)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				float num4 = Common.FloatRange(Common._M(4f), Common._M1(6f));
				eggFragment.mVX = SexyMath.CosF(num3) * num4;
				eggFragment.mVY = -SexyMath.SinF(num3) * num4;
		...
		// Token: 0x06000E8E RID: 3726 RVA: 0x000964FC File Offset: 0x000946FC
		protected override void DrawHearts(SexyGraphics g)
		{
			...
			for (int i = 0; i < Boss.NUM_HEARTS * 2; i++)
			{
				if (i >= num && i <= num2)
				{
					int num3 = (i < Boss.NUM_HEARTS) ? this.mHeartCels[i] : 0;
					if (this.mHP < this.mMaxHP - 1f)
					{
						num3 = 4;
					}
					g.DrawImageCel(Res.GetImageByID(ResID.IMAGE_BOSS_HEARTS), (int)(Common._S(this.mX + (float)this.mHeartXOff) + (float)(i * Res.GetImageByID(ResID.IMAGE_BOSS_HEARTS).GetCelWidth())), (int)Common._S(this.mY + (float)this.mHeartYOff), num3);
				}
			}
			g.PopState();
		}

		// Token: 0x06000E8F RID: 3727 RVA: 0x0009662A File Offset: 0x0009482A
		protected virtual void AddFeathers()
		{
			this.AddFeathers(false);
		}

		// Token: 0x06000E90 RID: 3728 RVA: 0x00096634 File Offset: 0x00094834
		...
		// Token: 0x06000E91 RID: 3729 RVA: 0x000967FC File Offset: 0x000949FC
		...
		// Token: 0x06000E92 RID: 3730 RVA: 0x00096856 File Offset: 0x00094A56
		public BossLame() : base(null)
		{
			this.Initialize();
		}

		// Token: 0x06000E93 RID: 3731 RVA: 0x0009687B File Offset: 0x00094A7B
		public BossLame(Level l) : base(l)
		{
			this.Initialize();
		}

		// Token: 0x06000E94 RID: 3732 RVA: 0x000968A0 File Offset: 0x00094AA0
		...
		// Token: 0x06000E95 RID: 3733 RVA: 0x00096954 File Offset: 0x00094B54
		...
		// Token: 0x06000E96 RID: 3734 RVA: 0x00096A5C File Offset: 0x00094C5C
		public override bool AllowFrogToFire()
		{
			return base.AllowFrogToFire() && this.mDeathTextTimer <= 0;
		}

		// Token: 0x06000E97 RID: 3735 RVA: 0x00096A74 File Offset: 0x00094C74
		public override void Update()
		{
			this.Update(1f);
		}

		// Token: 0x06000E98 RID: 3736 RVA: 0x00096A84 File Offset: 0x00094C84
		...
		// Token: 0x06000E99 RID: 3737 RVA: 0x0009718C File Offset: 0x0009538C
		...
		// Token: 0x06000E9A RID: 3738 RVA: 0x000972E4 File Offset: 0x000954E4
		...
		// Token: 0x06000E9B RID: 3739 RVA: 0x00097308 File Offset: 0x00095508
		...
		// Token: 0x06000E9C RID: 3740 RVA: 0x00097400 File Offset: 0x00095600
		...
		// Token: 0x06000E9D RID: 3741 RVA: 0x000974FC File Offset: 0x000956FC
		...
		// Token: 0x06000E9E RID: 3742 RVA: 0x0009759C File Offset: 0x0009579C
