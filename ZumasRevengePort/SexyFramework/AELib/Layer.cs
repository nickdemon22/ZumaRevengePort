...
namespace SexyFramework.AELib
{
	...
	public class Layer
	{
		...
		public virtual void Draw(SexyGraphics g, CumulativeTransform ctrans)
		{
			this.Draw(g, ctrans, -1);
		}

		// Token: 0x0600002E RID: 46 RVA: 0x00002D8A File Offset: 0x00000F8A
		public virtual void Draw(SexyGraphics g, CumulativeTransform ctrans, int frame)
		{
		...
		public virtual void Draw(SexyGraphics g, CumulativeTransform ctrans, int frame, float scale)
		{
			float num = 0f;
