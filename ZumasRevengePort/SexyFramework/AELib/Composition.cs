...
namespace SexyFramework.AELib
{
	...
	public class Composition : Layer
	{
		...
		public override void Draw(SexyGraphics g, CumulativeTransform ctrans)
		{
			this.Draw(g, ctrans, -1);
		}

		// Token: 0x0600003F RID: 63 RVA: 0x00003280 File Offset: 0x00001480
		public override void Draw(SexyGraphics g, CumulativeTransform ctrans, int frame)
		{
			this.Draw(g, ctrans, frame, 1f);
		}

		// Token: 0x06000040 RID: 64 RVA: 0x00003290 File Offset: 0x00001490
		public override void Draw(SexyGraphics g, CumulativeTransform ctrans, int frame, float scale)
		{
			if (frame == -1)
			{
