...
namespace JeffLib
{
	...
	public class ExtraSexyButton : ButtonWidget
	{
		...
		public ExtraSexyButton(int theId, ButtonListener theButtonListener) : base(theId, theButtonListener)
		{
			...
			this.mOverColor = (this.mDownColor = new Color(0, 0, 0, 0));
		}
		...
		public override void Draw(SexyGraphics pGfx)
		{
			if (!this.mDraw)
			{
				return;
		...
		public void DrawBoundingBox(SexyGraphics pGfx)
		{
