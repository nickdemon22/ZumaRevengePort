...
namespace JeffLib
{
	...
	public static class CommonGraphics
	{
		...
		public static void DrawCircle(SexyGraphics g, float center_x, float center_y, float r, int num_segments)
		{
		...
		public static void DrawCircle(SexyGraphics g, float center_x, float center_y, float r, int num_segments, bool fill)
		{
		...
		public static void DrawCircle(SexyGraphics g, float center_x, float center_y, float r, int num_segments, bool fill, float max_angle)
		{
			float num = max_angle / (float)num_segments;
			float num2 = 0f;
			Point[] array = new Point[num_segments];
		...
		public static void DrawPoly(SexyGraphics g, Point[] vertices, int num_vertices)
		{
			for (int i = 0; i < num_vertices; i++)
			{
				Point point = vertices[(i == num_vertices - 1) ? 0 : (i + 1)];
