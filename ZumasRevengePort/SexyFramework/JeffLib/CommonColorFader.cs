	...
	public class CommonColorFader
	{
		...
		public bool Update()
		{
			...
			if (this.mForward)
			{
				...
				if (JCommon._ATLIMIT(this.mColor.mRed, this.mMaxColor.mRed, this.mRedChange))
				{
					num++;
					this.mColor.mRed = this.mMaxColor.mRed;
				}
				if (JCommon._ATLIMIT(this.mColor.mGreen, this.mMaxColor.mGreen, this.mGreenChange))
				{
					num++;
					this.mColor.mGreen = this.mMaxColor.mGreen;
				}
				if (JCommon._ATLIMIT(this.mColor.mBlue, this.mMaxColor.mBlue, this.mBlueChange))
				{
					num++;
					this.mColor.mBlue = this.mMaxColor.mBlue;
				}
				if (JCommon._ATLIMIT(this.mColor.mAlpha, this.mMaxColor.mAlpha, this.mAlphaChange))
				{
					num++;
			...
			else
			{
				...
				this.mColor.mBlue -= this.mBlueChange;
				this.mColor.mAlpha -= this.mAlphaChange;
				if (JCommon._ATLIMIT(this.mColor.mRed, this.mMinColor.mRed, -this.mRedChange))
				{
					num++;
					this.mColor.mRed = this.mMinColor.mRed;
				}
				if (JCommon._ATLIMIT(this.mColor.mGreen, this.mMinColor.mGreen, -this.mGreenChange))
				{
					num++;
					this.mColor.mGreen = this.mMinColor.mGreen;
				}
				if (JCommon._ATLIMIT(this.mColor.mBlue, this.mMinColor.mBlue, -this.mBlueChange))
				{
					num++;
					this.mColor.mBlue = this.mMinColor.mBlue;
				}
				if (JCommon._ATLIMIT(this.mColor.mAlpha, this.mMinColor.mAlpha, -this.mAlphaChange))
				{
					num++;
