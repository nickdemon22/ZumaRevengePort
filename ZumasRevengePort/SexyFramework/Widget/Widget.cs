...
namespace SexyFramework.Widget
{
	...
	public abstract class Widget : WidgetContainer
	{
		...
		public void CopyFrom(Widget rhs)
		{
			...
			{
				this.mColors.Add(new Color(rhs.mColors[i]));
			}
		}
		...
		public virtual void SetColors4(int[,] theColors, int theNumColors)
		{
			...
			for (int i = 0; i < theNumColors; i++)
			{
				this.SetColor(i, new Color(theColors[i, 0], theColors[i, 1], theColors[i, 2], theColors[i, 3]));
			}
			this.MarkDirty();
		}
		...
		public virtual void DrawOverlay(SexyGraphics g)
		{
		}

		// Token: 0x0600088E RID: 2190 RVA: 0x0002BE5D File Offset: 0x0002A05D
		public virtual void DrawOverlay(SexyGraphics g, int thePriority)
		{
			this.DrawOverlay(g);
		}
		...
		public virtual void KeyDown(KeyCode theKey)
		{
			...
			{
				if (this.mWidgetManager.mKeyDown[(int)(KeyCode)16])
				{
		...
		public virtual Rect WriteCenteredLine(SexyGraphics g, int anOffset, string theLine)
		{
			Font font = g.GetFont();
		...
		public virtual int WriteString(SexyGraphics g, string theString, int theX, int theY, int theWidth, int theJustification, bool drawString, int theOffset, int theLength)
		{
		...
		public virtual int WriteWordWrapped(SexyGraphics g, Rect theRect, string theLine, int theLineSpacing, int theJustification)
		{
			bool flag = g.mWriteColoredString;
			g.mWriteColoredString = Widget.mWriteColoredString;
		...
		public int GetWordWrappedHeight(SexyGraphics g, int theWidth, string theLine, int aLineSpacing)
		{
			int num = 0;
			int num2 = 0;
		...
		public virtual void WriteNumberFromStrip(SexyGraphics g, int theNumber, int theX, int theY, Image theNumberStrip, int aSpacing)
		{
			int num = 10;
			int num2 = 1;
			while (theNumber >= num)
