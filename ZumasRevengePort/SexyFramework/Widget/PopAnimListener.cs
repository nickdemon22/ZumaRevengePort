...
namespace SexyFramework.Widget
{
	...
	public interface PopAnimListener
	{
		...
		bool PopAnimObjectPredraw(int theId, SexyGraphics g, PASpriteInst theSpriteInst, PAObjectInst theObjectInst, PATransform theTransform, Color theColor);

		// Token: 0x0600109E RID: 4254
		bool PopAnimObjectPostdraw(int theId, SexyGraphics g, PASpriteInst theSpriteInst, PAObjectInst theObjectInst, PATransform theTransform, Color theColor);

		// Token: 0x0600109F RID: 4255
		ImagePredrawResult PopAnimImagePredraw(int theId, PASpriteInst theSpriteInst, PAObjectInst theObjectInst, PATransform theTransform, Image theImage, SexyGraphics g, int theDrawCount);
