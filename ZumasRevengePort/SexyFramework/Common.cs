...
namespace SexyFramework
{
	...
	public static class Common
	{
		...
		public static float AngleBetweenPoints(Point p1, Point p2)
		{
		...
		public static void _RotatePointClockwise(Point p, float angle)
		{
		...
		public static bool RotatedRectsIntersect(Rect r1, float r1_angle, Rect r2, float r2_angle)
		{
			...
			Point point = new Point(r1.mWidth / 2, r1.mHeight / 2);
			Point point2 = new Point(r2.mWidth / 2, r2.mHeight / 2);
			Point p = new Point(r1.mX + point.mX, r1.mY + point.mY);
			Point theTPoint = new Point(r2.mX + point2.mX, r2.mY + point2.mY);
			Point point3 = new Point(theTPoint);
			point3 -= p;
		...
		public static float DistFromPointToLine(Point line_p1, Point line_p2, Point p, ref float t)
		{
