...
namespace SexyFramework.Misc
{
	...
	public class Bezier
	{
		...
		protected void SubdivideRender(SexyGraphics g, Vector2 P0, Vector2 P1, Vector2 P2, Vector2 P3)
		{
		...
		public void CopyFrom(Bezier rhs)
		{
			...
			this.mCurveColor = new Color(rhs.mCurveColor);
			if (rhs.mImage != null)
			{
		...
		public void Deserialize(Buffer b)
		{
			...
			this.mCurveColor = new Color((int)b.ReadLong());
			if (this.mCount > 0)
			{
				this.mTimes = new float[this.mCount];
				this.mPositions = new Vector2[this.mCount];
		...
		public void GenerateCurveImage(Color curve_color, int detail)
		{
			...
			this.mImage.Clear();
			SexyGraphics graphics = new SexyGraphics(this.mImage);
		...
		public void Draw(SexyGraphics g, float scale)
		{
			if (this.mImage == null)
			{
		...
		public Color mCurveColor = default(Color);
