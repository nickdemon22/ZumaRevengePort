...
namespace SexyFramework.PIL
{
	...
	public class System
    {
		...
		public void Draw(SexyGraphics g, bool draw_debug_info, int debugx, int debugy)
		{
			this.mFrameCount++;
			for (int i = 0; i < this.mEmitters.size<EmitterUpdatePair>(); i++)
			{
		...
		public static System Deserialize(Buffer b, GlobalMembers.GetImageByIdFunc f)
		{
			...
			PILSystem system = new PILSystem(particle_pool_size, particle_pool_grow);
		...
		public PILSystem.FPSCallback mFPSCallback;
