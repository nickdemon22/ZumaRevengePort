...
namespace SexyFramework.PIL
{
	...
	public class Particle : MovableObject
	{
		...
		private void DoDraw(SexyGraphics g, Transform t, float scale)
		{
			if (g.Is3D())
			{
		...
		private void DoDraw(SexyGraphics g, Transform t)
		{
			this.DoDraw(g, t, 1f);
		}
		...
		public virtual void Draw(SexyGraphics g, float alpha_pct, Color tint_color, float tint_strength, float scale)
		{
			...
			Color color = this.mColorKeyManager.GetColor();
		...
		public virtual void Draw(SexyGraphics g, float alpha_pct, Color tint_color, float tint_strength)
		{
