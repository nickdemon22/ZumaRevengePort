...
namespace SexyFramework.Drivers
{
	...
	public abstract class IAppDriver
	{
		...
		public abstract bool CheckSignature(Buffer theBuffer, string theFileName);
		...
		public abstract bool WriteBufferToFile(string theFileName, Buffer theBuffer);

		// Token: 0x060000B0 RID: 176
		public abstract bool ReadBufferFromFile(string theFileName, Buffer theBuffer, bool dontWriteToDemo);
