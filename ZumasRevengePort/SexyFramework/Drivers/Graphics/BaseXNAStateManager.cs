...
namespace SexyFramework.Drivers.Graphics
{
	...
	public class BaseXNAStateManager : RenderStateManager
	{
		...
		private void SetMaterialAmbient(Color inColor, int inVertexColorComponent)
		{
		}

		// Token: 0x060001F1 RID: 497 RVA: 0x00007145 File Offset: 0x00005345
		private void SetMaterialDiffuse(Color inColor, int inVertexColorComponent)
		{
		}

		// Token: 0x060001F2 RID: 498 RVA: 0x00007147 File Offset: 0x00005347
		private void SetMaterialSpecular(Color inColor, int inVertexColorComponent, float inPower)
		{
		}

		// Token: 0x060001F3 RID: 499 RVA: 0x00007149 File Offset: 0x00005349
		private void SetMaterialEmissive(Color inColor, int inVertexColorComponent)
		{
		}
