...
namespace SexyFramework.Graphics
{
	...
	public class RenderEffectAutoState
	{
		...
		public RenderEffectAutoState(SexyGraphics inGraphics, RenderEffect inEffect) : this(inGraphics, inEffect, 1)
		{
		}

		// Token: 0x06000741 RID: 1857 RVA: 0x00025EE5 File Offset: 0x000240E5
		public RenderEffectAutoState(SexyGraphics inGraphics) : this(inGraphics, null, 1)
		{
		}

		// Token: 0x06000742 RID: 1858 RVA: 0x00025EF0 File Offset: 0x000240F0
		public RenderEffectAutoState() : this(null, null, 1)
		{
		}

		// Token: 0x06000743 RID: 1859 RVA: 0x00025EFC File Offset: 0x000240FC
		public RenderEffectAutoState(SexyGraphics inGraphics, RenderEffect inEffect, int inDefaultPassCount)
		{
		...
		public void Reset(SexyGraphics inGraphics, RenderEffect inEffect)
		{
			this.Reset(inGraphics, inEffect, 1);
		}

		// Token: 0x06000746 RID: 1862 RVA: 0x00025FD3 File Offset: 0x000241D3
		public void Reset(SexyGraphics inGraphics)
		{
		...
		public void Reset(SexyGraphics inGraphics, RenderEffect inEffect, int inDefaultPassCount)
		{
			if (this.mEffect != null)
			{
				if (this.mCurrentPass < this.mPassCount)
