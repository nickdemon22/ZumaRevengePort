...
namespace SexyFramework.Graphics
{
	...
	public static class GlobalMembersGraphics
	{
		...
		public static int WriteWordWrappedHelper(SexyGraphics g, string theString, int theX, int theY, int theWidth, int theJustification, bool drawString, int theOffset, int theLength, int theOldColor, int theMaxChars)
		{
