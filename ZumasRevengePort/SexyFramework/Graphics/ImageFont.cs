...
namespace SexyFramework.Graphics
{
	...
	public class ImageFont : Font
	{
		...
		public ImageFont(ImageFont theImageFont) : base(theImageFont)
		{
					...
					if (flag2)
					{
						...
						else
						{
							...
							if (!flag3)
							{
								...
								SexyGraphics graphics = new SexyGraphics(memoryImage2);
								num4 = 0;
							...
							SexyGraphics graphics2 = new SexyGraphics(memoryImage);
							num7 = fontLayer.mCharDataHashTable.CharCount();
							array2 = fontLayer.mCharDataHashTable.ToArray();
		...
		public virtual void DrawStringEx(SexyGraphics g, int theX, int theY, string theString, Color theColor, Rect theClipRect, LinkedList<Rect> theDrawnAreas, ref int theWidth)
		{
			new AutoCrit(GlobalMembers.gSexyAppBase.mImageSetCritSect);
		...
		public override void DrawString(SexyGraphics g, int theX, int theY, string theString, Color theColor, Rect theClipRect)
		{
			int num = 0;
