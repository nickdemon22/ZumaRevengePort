...
namespace SexyFramework.Graphics
{
	...
	public abstract class RenderStateManager
	{
		...
		public class State
		{
			...
			public State(RenderStateManager inManager, uint inContext0, uint inContext1, uint inContext2) : this(inManager, inContext0, inContext1, inContext2, 0U)
			{
			}

			// Token: 0x060001A9 RID: 425 RVA: 0x00005B05 File Offset: 0x00003D05
			public State(RenderStateManager inManager, uint inContext0, uint inContext1) : this(inManager, inContext0, inContext1, 0U, 0U)
			{
			}

			// Token: 0x060001AA RID: 426 RVA: 0x00005B12 File Offset: 0x00003D12
			public State(RenderStateManager inManager, uint inContext0) : this(inManager, inContext0, 0U, 0U, 0U)
			{
			}

			// Token: 0x060001AB RID: 427 RVA: 0x00005B1F File Offset: 0x00003D1F
			public State(RenderStateManager inManager) : this(inManager, 0U, 0U, 0U, 0U)
			{
			}

			// Token: 0x060001AC RID: 428 RVA: 0x00005B2C File Offset: 0x00003D2C
			public State() : this(null, 0U, 0U, 0U, 0U)
			{
			}
