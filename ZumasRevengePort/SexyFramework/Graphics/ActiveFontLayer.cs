...
namespace SexyFramework.Graphics
{
	...
	public class ActiveFontLayer
	{
		...
		public void PushColor(Color theColor)
		{
			...
			Color color = this.mColorStack[this.mColorStack.Count - 1];
			Color color2 = new Color(theColor.mRed * color.mRed / 255, theColor.mGreen * color.mGreen / 255, theColor.mBlue * color.mBlue / 255, theColor.mAlpha * color.mAlpha / 255);
