...
namespace SexyFramework.Graphics
{
	...
	{
		// Token: 0x0600064D RID: 1613 RVA: 0x0001744C File Offset: 0x0001564C
		public override bool Error(string theError)
		{
			return false;
		}

		// Token: 0x0600064E RID: 1614 RVA: 0x00017450 File Offset: 0x00015650
		...
		// Token: 0x0600064F RID: 1615 RVA: 0x00017500 File Offset: 0x00015700
		...
		// Token: 0x06000650 RID: 1616 RVA: 0x00017550 File Offset: 0x00015750
			...
			else if (text.Equals("LayerSetCharOffsets"))
			{
					...
					if (this.DataToLayer(theParams.mElementVector[1], ref fontLayer18) && base.DataToStringVector(theParams.mElementVector[2], ref list13) && base.DataToList(theParams.mElementVector[3], ref listDataElement5))
					{
						if (list13.Count == listDataElement5.mElementVector.Count)
						{
							for (int num10 = 0; num10 < list13.Count; num10++)
							{
								...
								{
									fontLayer18.GetCharData(list13[num10][0]).mOffset = new Point(list14[0], list14[1]);
								}
								else
								{
									flag2 = true;
				...
				else if (theParams.mElementVector.Count == 3)
				{
					...
					if (this.DataToLayer(theParams.mElementVector[1], ref fontLayer19) && base.DataToStringVector(theParams.mElementVector[2], ref list15))
					{
						...
						{
							new List<int>();
							fontLayer19.GetCharData(list15[num11][0]).mOffset = new Point(0, 0);
						}
					}
				}
				else
		...
		// Token: 0x06000651 RID: 1617 RVA: 0x00019008 File Offset: 0x00017208
		public FontData()
		{
		...
		// Token: 0x06000652 RID: 1618 RVA: 0x00019058 File Offset: 0x00017258
		...
		// Token: 0x06000653 RID: 1619 RVA: 0x000190A5 File Offset: 0x000172A5
		public void Ref()
		{
			this.mRefCount++;
		}

		// Token: 0x06000654 RID: 1620 RVA: 0x000190B8 File Offset: 0x000172B8
		public void DeRef()
		{
			if (--this.mRefCount == 0)
			{
		...
		// Token: 0x06000655 RID: 1621 RVA: 0x000190E0 File Offset: 0x000172E0
		...
		// Token: 0x06000656 RID: 1622 RVA: 0x0001912C File Offset: 0x0001732C
		...
		// Token: 0x06000657 RID: 1623 RVA: 0x00019188 File Offset: 0x00017388
