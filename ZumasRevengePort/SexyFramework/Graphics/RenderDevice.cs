...
namespace SexyFramework.Graphics
{
	...
	public abstract class RenderDevice
	{
		...
		public abstract void FillScanLinesWithCoverage(RenderDevice.Span theSpans, int theSpanCount, Color theColor, int theDrawMode, string theCoverage, int theCoverX, int theCoverY, int theCoverWidth, int theCoverHeight);
		...
		public virtual void FillScanLines(RenderDevice.Span[] theSpans, int theSpanCount, Color theColor, int theDrawMode)
		{
