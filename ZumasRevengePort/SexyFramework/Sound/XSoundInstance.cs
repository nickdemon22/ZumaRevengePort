...
namespace SexyFramework.Sound
{
	...
	public class XSoundInstance : SoundInstance
	{
		...
		public override bool Play(bool looping, bool autoRelease)
		{
			this.Stop();
			this.didPlay = true;
			if (this.m_SoundInstance.State == SoundState.Paused)
			{
		...
		{
			return this.m_SoundInstance != null && this.m_SoundInstance.State == SoundState.Stopped;
		}
		...
		{
			return this.didPlay && this.m_SoundInstance.State == SoundState.Paused;
		}
