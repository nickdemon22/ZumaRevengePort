...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000D51 RID: 3409 RVA: 0x00085BC4 File Offset: 0x00083DC4
		protected override bool PreBulletUpdate(BossBullet b, int index)
		{
			...
			else if (b.mState == 0)
			{
				...
				if (bossFiringState != null)
				{
					...
					float num6 = 3.14159f - Common.GetCanonicalAngleRad(base.FireBulletAtPlayer(b, Common.FloatRange(base.mMinBulletSpeed, base.mMaxBulletSpeed), this.mX - (float)(this.mWidth / 2) + (float)(image.mWidth / 2) + (float)num4, this.mY - (float)(this.mHeight / 2) + (float)(image.mHeight / 2) + (float)num5)) + 1.570795f;
					num6 *= -1f;
					b.mTargetVX = b.mVX;
					b.mTargetVY = b.mVY;
		...
		// Token: 0x06000D52 RID: 3410 RVA: 0x00085E12 File Offset: 0x00084012
		...
		// Token: 0x06000D53 RID: 3411 RVA: 0x00085E20 File Offset: 0x00084020
		...
		// Token: 0x06000D54 RID: 3412 RVA: 0x00085E74 File Offset: 0x00084074
		protected override void DrawBossSpecificArt(SexyGraphics g)
		{
			...
			if (this.mLeftPaw.mState < 4 || this.mLeftPaw.mState >= 6)
			{
				...
				g.PushState();
				if (!Common._eq(this.mLeftPaw.mSkullGrowPct, 1f, 0.001f))
				{
					g.SetColorizeImages(true);
			...
			if (this.mRightPaw.mState < 4 || this.mRightPaw.mState >= 6)
			{
				...
				g.PushState();
				if (!Common._eq(this.mRightPaw.mSkullGrowPct, 1f, 0.001f))
				{
					g.SetColorizeImages(true);
		...
		// Token: 0x06000D55 RID: 3413 RVA: 0x000869F2 File Offset: 0x00084BF2
		protected override void BulletErased(int index)
		{
		}

		// Token: 0x06000D56 RID: 3414 RVA: 0x000869F4 File Offset: 0x00084BF4
		...
		// Token: 0x06000D57 RID: 3415 RVA: 0x00086A4C File Offset: 0x00084C4C
		...
		// Token: 0x06000D58 RID: 3416 RVA: 0x00086B44 File Offset: 0x00084D44
		...
		// Token: 0x06000D59 RID: 3417 RVA: 0x00086BF4 File Offset: 0x00084DF4
		protected void SyncSkull(DataSync sync, Skull s)
		{
			...
			skull.mFatHead = new PILSystem(50, 50);
		...
		// Token: 0x06000D5A RID: 3418 RVA: 0x00086EA3 File Offset: 0x000850A3
		protected override bool CanTaunt()
		{
			return this.mTutorialState == 0;
		}

		// Token: 0x06000D5B RID: 3419 RVA: 0x00086EB0 File Offset: 0x000850B0
		...
		// Token: 0x06000D5C RID: 3420 RVA: 0x00086FAB File Offset: 0x000851AB
		protected override bool CanFire()
		{
			return this.mTutorialState == 0;
		}

		// Token: 0x06000D5D RID: 3421 RVA: 0x00086FB6 File Offset: 0x000851B6
		...
		// Token: 0x06000D5E RID: 3422 RVA: 0x00086FD4 File Offset: 0x000851D4
		...
		// Token: 0x06000D5F RID: 3423 RVA: 0x00087024 File Offset: 0x00085224
		public BossTiger(Level l) : base(l)
		{
		...
		// Token: 0x06000D60 RID: 3424 RVA: 0x00087130 File Offset: 0x00085330
		public BossTiger() : this(null)
		{
		}

		// Token: 0x06000D61 RID: 3425 RVA: 0x0008713C File Offset: 0x0008533C
		...
		// Token: 0x06000D62 RID: 3426 RVA: 0x00087222 File Offset: 0x00085422
		public bool ShouldEraseBullets()
		{
			return this.mTutorialState <= 2 && this.mTutorialState > 0 && this.mTauntQueue.Count <= 1;
		}

		// Token: 0x06000D63 RID: 3427 RVA: 0x0008724C File Offset: 0x0008544C
		...
		// Token: 0x06000D64 RID: 3428 RVA: 0x000872AB File Offset: 0x000854AB
		public override int GetFrogReloadType()
		{
			if (this.mTutorialState == 2)
			{
				return Common.Rand() % 4;
			}
			return base.GetFrogReloadType();
		}

		// Token: 0x06000D65 RID: 3429 RVA: 0x000872C4 File Offset: 0x000854C4
		public override void Update(float f)
		{
			...
			if (this.mLevel.AllCurvesAtRolloutPoint())
			{
				...
				else if (Common._geq(this.mAlphaOverride, 255f))
				{
					BossFiringState[] array = new BossFiringState[]
					{
						this.mLeftPaw,
						this.mRightPaw
					};
		...
		// Token: 0x06000D66 RID: 3430 RVA: 0x00088204 File Offset: 0x00086404
		...
		// Token: 0x06000D67 RID: 3431 RVA: 0x00088568 File Offset: 0x00086768
		...
		// Token: 0x06000D68 RID: 3432 RVA: 0x000886A4 File Offset: 0x000868A4
		...
		// Token: 0x06000D69 RID: 3433 RVA: 0x00088714 File Offset: 0x00086914
		...
		// Token: 0x06000D6A RID: 3434 RVA: 0x000887CC File Offset: 0x000869CC
