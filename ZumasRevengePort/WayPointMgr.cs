...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000DC7 RID: 3527 RVA: 0x0008C344 File Offset: 0x0008A544
		protected void DrawCurvePiece(SexyGraphics g, int theWayPoint, float theThickness)
		{
			if (theWayPoint == 0)
			{
				return;
			...
			SexyVector3 sexyVector = this.CalcPerpendicular((float)(theWayPoint - 1)) * theThickness;
			SexyVector3 sexyVector2 = this.CalcPerpendicular((float)theWayPoint) * theThickness;
			...
			g.PolyFill(array, 4, false);
		}

		// Token: 0x06000DC8 RID: 3528 RVA: 0x0008C4DE File Offset: 0x0008A6DE
		public WayPointMgr()
		{
		}

		// Token: 0x06000DC9 RID: 3529 RVA: 0x0008C4F1 File Offset: 0x0008A6F1
		...
		// Token: 0x06000DCA RID: 3530 RVA: 0x0008C51E File Offset: 0x0008A71E
		public virtual void Dispose()
		{
			this.mWayPoints.Clear();
		}

		// Token: 0x06000DCB RID: 3531 RVA: 0x0008C52C File Offset: 0x0008A72C
		...
		// Token: 0x06000DCC RID: 3532 RVA: 0x0008C6A4 File Offset: 0x0008A8A4
		...
		// Token: 0x06000DCD RID: 3533 RVA: 0x0008C73C File Offset: 0x0008A93C
		...
		// Token: 0x06000DCE RID: 3534 RVA: 0x0008C801 File Offset: 0x0008AA01
		...
		// Token: 0x06000DCF RID: 3535 RVA: 0x0008C810 File Offset: 0x0008AA10
		...
		// Token: 0x06000DD0 RID: 3536 RVA: 0x0008C85C File Offset: 0x0008AA5C
		...
		// Token: 0x06000DD1 RID: 3537 RVA: 0x0008C8B0 File Offset: 0x0008AAB0
		...
		// Token: 0x06000DD2 RID: 3538 RVA: 0x0008C900 File Offset: 0x0008AB00
		...
		// Token: 0x06000DD3 RID: 3539 RVA: 0x0008CAD4 File Offset: 0x0008ACD4
		...
		// Token: 0x06000DD4 RID: 3540 RVA: 0x0008CC2C File Offset: 0x0008AE2C
		...
		// Token: 0x06000DD5 RID: 3541 RVA: 0x0008CC6C File Offset: 0x0008AE6C
		...
		// Token: 0x06000DD6 RID: 3542 RVA: 0x0008CC93 File Offset: 0x0008AE93
		public int GetPriority(Bullet theBullet)
		{
			...
			int priority = this.GetPriority((int)(theBullet.GetWayPoint() - (float)theBullet.GetRadius()));
			int priority2 = this.GetPriority((int)(theBullet.GetWayPoint() + (float)theBullet.GetRadius()));
			return Math.Max(priority, priority2);
		}

		// Token: 0x06000DD7 RID: 3543 RVA: 0x0008CCB8 File Offset: 0x0008AEB8
		...
		// Token: 0x06000DD8 RID: 3544 RVA: 0x0008CE94 File Offset: 0x0008B094
		public void DrawCurve(SexyGraphics g, Color theColor, int theDangerPoint)
		{
			if (this.mWayPoints.Count == 0)
			{
				return;
		...
		// Token: 0x06000DD9 RID: 3545 RVA: 0x0008CEDC File Offset: 0x0008B0DC
		...
		// Token: 0x06000DDA RID: 3546 RVA: 0x0008CF46 File Offset: 0x0008B146
		...
		// Token: 0x06000DDB RID: 3547 RVA: 0x0008CF70 File Offset: 0x0008B170
		...
		// Token: 0x06000DDC RID: 3548 RVA: 0x0008CFA8 File Offset: 0x0008B1A8
		...
		// Token: 0x06000DDD RID: 3549 RVA: 0x0008CFF0 File Offset: 0x0008B1F0
		...
		// Token: 0x06000DDE RID: 3550 RVA: 0x0008D0A6 File Offset: 0x0008B2A6
		public int GetNumPoints()
		{
			return Enumerable.Count<WayPoint>(this.mWayPoints);
		}

		// Token: 0x06000DDF RID: 3551 RVA: 0x0008D0B3 File Offset: 0x0008B2B3
		public int GetEndPoint()
		{
			return Enumerable.Count<WayPoint>(this.mWayPoints) - 1;
		}

		// Token: 0x06000DE0 RID: 3552 RVA: 0x0008D0C2 File Offset: 0x0008B2C2
