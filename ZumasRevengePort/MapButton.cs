...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000DA1 RID: 3489 RVA: 0x0008B11C File Offset: 0x0008931C
		public MapButton(int id, ButtonListener l) : base(id, l)
		{
		}

		// Token: 0x06000DA2 RID: 3490 RVA: 0x0008B128 File Offset: 0x00089328
		public override void Draw(SexyGraphics g)
		{
			...
			if (((!GameApp.gApp.mUserProfile.mFirstTimeReplayingNormalMode && !GameApp.gApp.mClickedHardMode) || (GameApp.gApp.mClickedHardMode && !GameApp.gApp.mUserProfile.mFirstTimeReplayingHardMode)) && !GameApp.gApp.mUserProfile.GetAdvModeVars().mFirstTimeInZone[0])
			{
				...
				if (num == 0)
				{
					int num6 = Common._M(0) + Common.GetAlphaFromUpdateCount(this.mUpdateCnt, Common._M1(128));
					if (num6 > 255)
					{
						num6 = 255;
					}
				...
				int num8 = 0;
				if ((int)Localization.GetCurrentLanguage() == 10 || (int)Localization.GetCurrentLanguage() == 5 || (int)Localization.GetCurrentLanguage() == 6 || (int)Localization.GetCurrentLanguage() == 7)
				{
					num8 = 10;
				}
				...
				{
					if ((int)Localization.GetCurrentLanguage() == 6 || (int)Localization.GetCurrentLanguage() == 7 || (int)Localization.GetCurrentLanguage() == 1)
					{
						int num9 = 128;
						int num10 = 120;
						float num11 = 0.75f;
			...
			else if (!this.mMapScreen.mRemove)
			{
				if (num == 0)
				{
					int num12 = Common._M(0) + Common.GetAlphaFromUpdateCount(this.mUpdateCnt, Common._M1(128));
					if (num12 > 255)
					{
						num12 = 255;
					}
				...
				int num14 = 0;
				int num15 = 0;
				if ((int)Localization.GetCurrentLanguage() == 11 || (int)Localization.GetCurrentLanguage() == 8 || (int)Localization.GetCurrentLanguage() == 9)
				{
					num14 = 20;
					num15 = -20;
				}
				else if ((int)Localization.GetCurrentLanguage() == 7)
				{
					num14 = 30;
					num15 = -30;
				}
				else if ((int)Localization.GetCurrentLanguage() == 4)
				{
					num14 = 15;
					num15 = -10;
				}
				else if ((int)Localization.GetCurrentLanguage() == 3)
				{
					num14 = 16;
					num15 = 0;
				}
				else if ((int)Localization.GetCurrentLanguage() == 6)
				{
					num14 = 16;
					num15 = -5;
				}
				else if ((int)Localization.GetCurrentLanguage() == 1)
				{
					num14 = 17;
					num15 = -20;
				}
