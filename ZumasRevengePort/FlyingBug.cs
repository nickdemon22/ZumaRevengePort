...
namespace ZumasRevenge
{
	...
	{
		// Token: 0x06000FDC RID: 4060 RVA: 0x000A290C File Offset: 0x000A0B0C
		...
		// Token: 0x06000FDD RID: 4061 RVA: 0x000A2988 File Offset: 0x000A0B88
		...
		// Token: 0x06000FDE RID: 4062 RVA: 0x000A2B90 File Offset: 0x000A0D90
		protected virtual void UpdateStateFlying(Critter d)
		{
			...
			d.mTimer--;
			Rect rect;
			rect = new Rect((int)d.mX, (int)d.mY, d.mImage.GetCelWidth(), d.mImage.GetCelHeight());
			Rect rect2;
			rect2 = new Rect(rect.mWidth, rect.mHeight, GameApp.gApp.mWidth - rect.mWidth * 2, GameApp.gApp.mHeight - rect.mHeight * 2);
			if ((d.mTimer <= 0 && (!this.mNoRotateUntilOnScreen || rect2.Intersects(rect))) || this.mNoEnterRect.Intersects(rect))
			{
				if (d.mTimer > 0)
				{
		...
		// Token: 0x06000FDF RID: 4063 RVA: 0x000A2D0C File Offset: 0x000A0F0C
		...
		// Token: 0x06000FE0 RID: 4064 RVA: 0x000A2E48 File Offset: 0x000A1048
		...
		// Token: 0x06000FE1 RID: 4065 RVA: 0x000A2F58 File Offset: 0x000A1158
		...
		// Token: 0x06000FE2 RID: 4066 RVA: 0x000A2FC8 File Offset: 0x000A11C8
		...
		// Token: 0x06000FE3 RID: 4067 RVA: 0x000A30E0 File Offset: 0x000A12E0
		public virtual void DrawBug(SexyGraphics g, Critter d, Transform t)
		{
		...
		// Token: 0x06000FE4 RID: 4068 RVA: 0x000A3260 File Offset: 0x000A1460
		public FlyingBug()
		{
		...
		// Token: 0x06000FE5 RID: 4069 RVA: 0x000A32F4 File Offset: 0x000A14F4
		...
		// Token: 0x06000FE6 RID: 4070 RVA: 0x000A3578 File Offset: 0x000A1778
		...
		// Token: 0x06000FE7 RID: 4071 RVA: 0x000A360F File Offset: 0x000A180F
